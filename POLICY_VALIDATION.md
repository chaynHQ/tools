...
1. Go to **Actions** → **Policy Validation Workflow**
2. Click **Run workflow**
3. Select the same platform and settings
4. A new PR will be created (old PRs are automatically closed)
...
- **Slack notifications**: The team receives notifications about validation results on #tools-webhook channel
