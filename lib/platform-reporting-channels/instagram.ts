...
export const instagramReportingChannels: PlatformReportingChannels = {
  platform: 'Instagram',
  channels: [
    {
      channelType: 'Form',
    ...
    },
    {
      ...
      isDMCA: false,
      isDefault: false,
      officialPurpose: 'To report an impersonating account on Instagram.',
      justification:
        "This is the required first step for all Instagram impersonation reports. It is tailored to the specific evidence needed for Instagram's identity verification process and is the only channel that will initiate a review.",
      contactDetail: {
