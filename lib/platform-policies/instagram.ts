...
export const instagramPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2025-09-24T13:59:56.366Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "appealProcess": {
      "url": null,
      "summary": "DMCA counter-notification process available for removed content",
      "steps": [
        "Submit a DMCA counter-notification to Instagram or Threads' designated agent",
        "Follow the process outlined in How Instagram and Threads process United States Digital Millennium Copyright Act (DMCA) counter-notifications"
      ]
    }
  }
],
