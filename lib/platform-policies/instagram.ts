...
export const instagramPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2025-09-24T13:47:32.871Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "appealProcess": {
      ...
      "summary": "Users can submit copyright infringement reports through Instagram's reporting form and utilize DMCA counter-notification process for disputes",
      "steps": [
        "Fill out the copyright infringement reporting form",
        "Submit the report to Instagram",
        "If content is removed and you believe it was wrongly removed, you can submit a DMCA counter-notification"
      ]
    }
  },
  {
  ...
  },
  {
    ...
    "summary": "Comprehensive privacy policy covering Facebook, Instagram, Messenger and other Meta products, detailing data collection, use, and sharing practices. Updated June 16, 2025.",
  ...
  },
  {
    ...
    "appealProcess": {
      ...
      "steps": [
        "Report content through the universal reporting option available on posts, comments, stories, messages, or profiles",
        "Receive notification of review decision via notifications and Support Inbox",
        "If disagreeing with the decision, request another review through the appeal option in the Support Inbox",
