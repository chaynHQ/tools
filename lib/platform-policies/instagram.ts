...
export const instagramPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2025-09-24T14:17:43.167Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "appealProcess": {
      ...
      "steps": [
        "Report content through the universal reporting option available on posts, comments, stories, messages, profiles",
  ...
  },
  {
    ...
    "appealProcess": {
      ...
      "steps": [
        ...
        "Content may be restored following proper counter-notification procedures"
      ]
    }
  },
  {
    "id": "instagram-new-1758723463167-0",
    "reference": "IG-APPEAL-PROCESS",
    "title": "Instagram Content Appeal Process",
    "summary": "Process for appealing content removal decisions including DMCA counter-notifications and general content appeals.",
    "url": "https://help.instagram.com/693680257839261/",
    "accessTimestamp": "2025-09-24T14:17:43.167Z",
    "policies": [],
    "appealProcess": {
      "url": "https://help.instagram.com/675885993348720",
      "summary": "Two-tier appeal process for Instagram content decisions - first through Instagram's internal review process, then optionally to the independent Oversight Board within 15 days",
      "steps": [
        "First go through Instagram's request a review process for your content or content you reported",
        "If you disagree with Instagram's decision after two reviews, you may be eligible to appeal to the Oversight Board",
        "Submit your appeal to the Oversight Board within 15 days of the decision",
        "The Oversight Board will decide whether to review your appeal (they only select certain eligible appeals)",
        "Check appeal status on the Oversight Board's website using your reference number"
      ]
    }
  }
],
