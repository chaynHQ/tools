  ...
  policyDocuments: [
    {
      ...
      summary:
        'US federal law that criminalizes nonconsensual publication of intimate images and requires covered platforms to implement notice-and-removal processes. Signed into law on May 19, 2025 as Public Law No. 119-12.',
      ...
      policies: [
        ...
        },
        {
          ...
          summary:
            'Prohibits knowingly publishing digitally forged intimate visual depictions of adults without consent when not voluntarily exposed publicly, not a matter of public concern, and intended to cause or causing harm',
          quote:
        ...
        },
        {
          ...
          summary:
            'Prohibits knowingly publishing digitally forged intimate visual depictions of minors with intent to abuse, humiliate, harass, degrade, or arouse sexual desire',
          quote:
        ...
        },
        {
          ...
          evidenceRequirements: [
            ...
            {
              description:
                'Brief statement of good faith belief that the intimate visual depiction is not consensual',
        ...
        },
        {
          ...
          summary:
            'Prohibits intentionally threatening to publish authentic intimate visual depictions for purposes of intimidation, coercion, extortion, or to create mental distress',
          quote:
        ...
        },
        {
          ...
          summary:
            'Prohibits intentionally threatening to publish digitally forged intimate visual depictions for purposes of intimidation, coercion, extortion, or to create mental distress',
          quote:
    ...
    },
    {
      ...
      summary:
        'Unified community standards that apply to Facebook, Instagram, Messenger and Threads, covering content policies including non-consensual intimate imagery, harassment, and content removal.',
      ...
      policies: [
        {
          ...
          summary:
            'Prohibits adult sexual exploitation including non-consensual sharing of intimate images',
        ...
        },
        {
          ...
          timeframes: null,
          evidenceRequirements: [],
          removalCriteria: ['Content misrepresents identity', 'Account or content is inauthentic'],
        },
        {
        ...
        },
        {
          ...
          summary:
            'Prohibits third-party intellectual property infringement including unauthorized use of personal images',
        ...
        },
        {
          ...
          reference: 'PRIVACY',
          summary:
            'Protects personal privacy and information, ensuring freedom to choose how and when to share',
          quote:
        ...
        },
        {
          ...
          reference: 'SAFETY',
          summary:
            'Removes content that threatens people or could contribute to physical security risks',
          quote:
    ...
    },
    {
      ...
      summary:
        "Instagram's terms of service outlining user obligations, content licensing, and platform rules. Updated effective January 1, 2025.",
      ...
      policies: [
        {
          ...
          summary:
            "Prohibits posting someone else's private or confidential information without permission",
          quote:
        ...
        },
        {
          ...
          reference: 'Section 4.2',
          summary:
            'Prohibits violating intellectual property rights including copyright infringement',
          quote:
        ...
        },
        {
          ...
          reference: 'Section 6',
          summary:
            'Allows removal of content that violates Terms of Use, policies, or Community Standards',
          quote:
            'We can remove any content or information you share on the Service if we believe that it violates these Terms of Use, our policies (including our Community Standards), or we are permitted or required to do so by law.',
          contentTypes: ['intimate', 'personal', 'private', 'other'],
          contentContexts: ['hacked', 'impersonation', 'relationship', 'unknown', 'other'],
          timeframes: null,
          evidenceRequirements: [],
        ...
        },
        {
          ...
          reference: 'Section 6',
          summary:
            'Allows account termination for Terms violations, policy violations, or repeated intellectual property infringement',
          quote:
        ...
        },
        {
          ...
          evidenceRequirements: [],
          removalCriteria: ['User requests content or account deletion'],
        },
      ],
      appealProcess: null,
    },
    {
      ...
      summary:
        "Instagram's copyright infringement reporting and DMCA takedown procedures for protecting intellectual property rights.",
      ...
      policies: [
        {
          ...
          summary:
            "Prohibits posting content that violates someone else's copyright without permission",
          quote:
            'If you believe someone is using your copyrighted work without your permission, you can report it to us by filling out this form.',
        ...
        },
        {
          ...
          summary:
            'Takes action against accounts that repeatedly post content violating intellectual property rights',
          quote:
        ...
        },
        {
          ...
          summary:
            'Provides process for users to dispute copyright takedown actions through DMCA counter-notifications',
          quote:
      ...
      appealProcess: {
        ...
        summary:
          'Users can submit DMCA counter-notifications to dispute copyright takedown actions and retract intellectual property reports they have submitted',
        steps: [
    ...
    },
    {
      ...
      summary:
        'Comprehensive policy on protecting intellectual property rights including copyright and trademark violations.',
      ...
      policies: [
        {
          ...
          summary:
            "Prohibits posting content that violates someone else's copyright, including original works of authorship such as images",
          quote:
        ...
        },
        {
          ...
          summary:
            "Prohibits posting content that violates someone else's trademark rights, including unauthorized use of distinguishing words, symbols or designs",
          quote:
    ...
    },
    {
      ...
      summary:
        'Guidance for users on reporting and addressing non-consensual sharing of intimate images.',
      ...
      policies: [
        {
          ...
          summary:
            'Prohibits intimate photos that violate Community Standards and enables anonymous reporting for removal',
          quote:
            "You can anonymously report photos that go against Instagram's Community Standards. After reporting a post, specially trained representatives from our Community Operations team will then review the image and remove it if it goes against our Community Standards.",
          contentTypes: ['intimate', 'personal'],
          contentContexts: ['hacked', 'impersonation', 'relationship', 'unknown', 'other'],
          timeframes: null,
          evidenceRequirements: [
        ...
        },
        {
          ...
          summary:
            'Prohibits threatening to share private content or demanding money/actions in exchange for not sharing private content',
          quote:
            "If someone is threatening to share things you want to keep private (example: messages, photos, videos), asking you to send money or asking you to do something else you're uncomfortable with, please report their profile to us using the built-in reporting options.",
          contentTypes: ['intimate', 'personal', 'private'],
          contentContexts: ['hacked', 'impersonation', 'relationship', 'unknown', 'other'],
          timeframes: null,
          evidenceRequirements: [
        ...
        },
        {
          ...
          summary:
            'Uses photo-matching technology to prevent future sharing of removed intimate images across Instagram, Facebook and Messenger',
          quote:
    ...
    },
    {
      ...
      summary:
        'Comprehensive privacy policy covering Facebook, Instagram, Messenger and other Meta products, detailing data collection, use, and sharing practices. Effective June 16, 2025.',
      ...
      policies: [
        {
          ...
          summary:
            'Prohibits harmful or unlawful behavior and provides for content removal when reported',
          quote:
        ...
        },
        {
          ...
          summary:
            'Provides for information access and preservation in response to legal requests and to prevent harm',
          quote:
        ...
        },
        {
          ...
          reference:
            'Section 6 - How can you manage or delete your information and exercise your rights?',
          summary: 'Allows users to delete their information or account',
          quote:
            'We offer you a variety of tools to view, manage, download and delete your information below. You can also manage your information by visiting the settings of the Products you use. You may also have other privacy rights under applicable laws. Delete your information or account.',
          contentTypes: ['intimate', 'personal', 'private', 'other'],
          contentContexts: ['hacked', 'impersonation', 'relationship', 'unknown', 'other'],
          timeframes: null,
          evidenceRequirements: [],
          removalCriteria: ['User requests deletion of their information or account'],
        },
      ],
      appealProcess: null,
    },
    {
      ...
      summary:
        'Dedicated reporting mechanism and policy for harassment and bullying content on Instagram.',
      ...
      policies: [
        {
          ...
          reference: null,
          summary:
            'Prohibits accounts established with the intent of bullying or harassing another person',
          quote:
        ...
        },
        {
          ...
          timeframes: null,
          evidenceRequirements: [],
          removalCriteria: ['Photo or comment is intended to bully or harass someone'],
        },
      ],
      appealProcess: null,
    },
    {
      ...
      summary:
        'Detailed policy on bullying and harassment across Meta platforms including specific protections for minors and private individuals.',
      ...
      policies: [
        {
          ...
          summary:
            'Prohibits unwanted contact that is repeated, sexually harassing, or directed at a large number of individuals with no prior solicitation',
          quote:
        ...
        },
        {
          ...
          reference: 'Tier 1: Universal protections for everyone',
          summary:
            'Prohibits statements of intent to engage in sexual activity or advocating to engage in sexual activity',
          quote:
        ...
        },
        {
          ...
          reference: 'Tier 1: Universal protections for everyone',
          summary:
            'Prohibits content that degrades or expresses disgust toward individuals depicted in the process of, or right after, menstruating, urinating, vomiting, or defecating',
          quote:
        ...
        },
        {
          ...
          summary:
            'Prohibits claims about sexual activity, except in the context of criminal allegations against adults',
          quote:
        ...
        },
        {
          ...
          timeframes: null,
          evidenceRequirements: [],
          removalCriteria: ['Content sexualizes another adult'],
        },
        {
        ...
        },
        {
          ...
          reference:
            'Tier 2: Additional protections for all Minors, Private Adults and Limited Scope Public Figures',
          summary:
            'Prohibits content that degrades individuals who are depicted being physically bullied',
          quote:
        ...
        },
        {
          ...
          summary:
            'Prohibits claims about romantic involvement, sexual orientation or gender identity',
          ...
          evidenceRequirements: [
            {
              ...
              example:
                'Report submitted by the targeted individual or their authorized representative',
        ...
        },
        {
          ...
          reference: 'Additional information and/or context to enforce',
          summary:
            'Removes content where the target is directly targeted and confirmation is received that the content is unwanted',
          quote:
          ...
          evidenceRequirements: [
            {
              ...
              example:
                'Written confirmation that the targeted individual does not want the content posted',
        ...
        },
        {
          ...
          reference: 'Additional information and/or context to enforce',
          summary:
            'Removes content sexualizing a public figure when confirmation is received that the content is unwanted',
          quote:
          ...
          evidenceRequirements: [
            {
              ...
              example:
                'Written confirmation from the public figure that they do not want the sexualizing content posted',
        ...
        },
        {
          ...
          reference: 'Additional information and/or context to enforce',
          summary:
            'Removes sexually harassing contact when confirmation is received that the contact is unwanted',
          quote:
          ...
          evidenceRequirements: [
            {
              ...
              example:
                'Written confirmation that the recipient does not want the sexually harassing contact',
      ...
      appealProcess: {
        ...
        summary:
          'Meta provides an appeals process where users can request another review if they disagree with enforcement decisions. Appeals are submitted through the Support Inbox with options to provide additional context.',
        steps: [
    ...
    {
      id: 'instagram-new-1758722051141-0',
      reference: 'IG-COPYRIGHT-REPORTING',
      title: 'Instagram Copyright Infringement Reporting',
      summary:
        'Detailed procedures for reporting copyright infringement on Instagram, including DMCA takedown processes and counter-notification procedures.',
      ...
      policies: [
        {
          ...
          summary:
            'Provides a mechanism for reporting copyright infringement of personal images and content on Instagram and Threads',
          ...
          evidenceRequirements: [
            {
              description: 'Specific information required in copyright report',
              example:
                'Information you need to include in a copyright report to Instagram or Threads',
              reason: 'To substantiate copyright ownership and infringement claims',
            },
            {
              description: 'URL link to infringing content',
              example: 'Get a link (URL) to a photo or video on Instagram or Threads',
              reason: 'To identify the specific content that infringes copyright',
            },
          ],
          removalCriteria: [
            'Content must infringe copyright',
            'Proper copyright report must be submitted with required information',
          ],
        },
      ],
      appealProcess: {
        url: null,
        summary:
          'Instagram and Threads process DMCA counter-notifications and provide information about what happens after copyright reports are submitted',
        steps: [
