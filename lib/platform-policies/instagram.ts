...
export const instagramPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2025-11-24T09:10:22.042Z",
    "policies": [
      {
    ...
    "policies": [
      {
        ...
        "summary": "Provides a mechanism for reporting copyright infringement of personal images and content on Instagram and Threads",
        ...
        "evidenceRequirements": [
          {
            ...
            "example": "Information you need to include in a copyright report to Instagram or Threads",
  ...
  {
    "id": "instagram-new-1763975422042-0",
    "reference": "META-NCII-HELP",
    "title": "Meta Non-Consensual Intimate Images Help",
    "summary": "Meta's comprehensive help center guidance for reporting and addressing non-consensual sharing of intimate images across Facebook, Instagram, and Messenger platforms.",
    "url": "https://www.meta.com/help/policies/867240510905645/",
    "accessTimestamp": "2025-11-24T09:10:22.042Z",
    "policies": [
      {
        "id": "meta-ncii-community-standards",
        "reference": "Community Standards",
        "summary": "Prohibits photos that violate Community Standards and enables removal through reporting",
        "quote": "You can anonymously report photos that go against our Community Standards.",
        "contentTypes": [
          "intimate",
          "personal",
          "other"
        ...
        "evidenceRequirements": [
          {
            ...
            "example": "Screenshot of the violating content",
            "reason": "Documentation may be needed for further action or legal proceedings"
          }
        ],
        "removalCriteria": [
          "Content goes against Community Standards",
          "Content is reported through built-in reporting options"
        ]
      },
      {
        "id": "meta-ncii-threats-sextortion",
        "reference": "Threatening Content",
        "summary": "Prohibits threatening to share private content or demanding money or actions in exchange for not sharing private content",
        "quote": "If someone is threatening to share things you want to keep private (example: messages, photos, videos), asking you to send money or asking you to do something else you're uncomfortable with, please report their profile to us using the built-in reporting options.",
        "contentTypes": [
          "intimate",
          "personal",
        ...
        "evidenceRequirements": [
          {
            ...
            "example": "Use platform's reporting system to flag the threatening account",
            "reason": "Enables platform review and enforcement action"
          }
        ],
        "removalCriteria": [
          "Someone is threatening to share private content",
          "Someone is demanding money to prevent sharing private content",
          "Someone is asking you to do something uncomfortable in exchange for not sharing private content"
        ]
      },
      {
        "id": "meta-ncii-photo-matching-prevention",
        "reference": "Photo-matching Technology",
        "summary": "Uses photo-matching technology to prevent future sharing of removed intimate images across Instagram, Facebook and Messenger",
        ...
        "evidenceRequirements": [
          {
            "description": "Initial report of the violating content",
            "example": "Report through built-in reporting system",
            "reason": "Triggers review process and enables photo-matching technology implementation"
          }
        ],
        "removalCriteria": [
          "Content goes against Community Guidelines",
          "Content has been reviewed by specially trained Community Operations representatives"
        ]
      },
      {
        "id": "meta-ncii-third-party-reporting",
        "reference": "Third-party Reporting",
        "summary": "Allows reporting of violating content with help from a friend if the victim does not have an account",
        ...
        "evidenceRequirements": [
          {
            "description": "Third-party assistance for reporting when victim lacks account access",
            "example": "Friend with account can submit report on behalf of victim",
            "reason": "Ensures victims can seek help even without platform access"
          }
        ],
        "removalCriteria": [
          "Content violates platform policies",
          "Report can be submitted by authorized third party when victim lacks account access"
        ]
      }
    ],
    "appealProcess": null
