...
export const onlyfansPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2025-12-01T09:09:07.858Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "summary": "Federal law enacted on May 19, 2025, criminalizing nonconsensual intimate imagery including AI-generated deepfakes and requiring covered platforms to establish notice-and-removal processes to remove such content within 48 hours of verified requests. Platforms have until May 19, 2026 to implement compliance systems. Violations are enforced under the Federal Trade Commission Act.",
