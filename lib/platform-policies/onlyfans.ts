...
export const onlyfansPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
      ...
      policies: [
        {
          ...
          summary:
            'Reserves the right to suspend or remove content that may breach Terms of Service',
          quote:
          ...
          removalCriteria: ['Content that may breach Terms of Service'],
        },
        {
          id: 'of-tou-illegal-content-removal',
          reference: 'Section 12.2',
          summary:
            'Uses proportionate measures to quickly remove illegal content when aware it is on the platform',
          quote:
          ...
          evidenceRequirements: [],
          removalCriteria: ['Content that is illegal under applicable laws'],
        },
        {
          id: 'of-tou-account-suspension',
          reference: 'Section 14.2',
          summary:
            'May suspend or delete accounts and content without warning for serious or repeated breaches',
          quote:
        ...
        },
        {
          ...
          quote:
            'You warrant that each individual in Co-Authored Content you Upload is: a Creator you have tagged using the tool available on OnlyFans; or an individual at least 18 years of age whose proof of identity and whose written, informed consent you have obtained to share the Content on OnlyFans.',
          contentTypes: ['intimate', 'personal'],
          contentContexts: ['relationship', 'other'],
          timeframes: null,
          evidenceRequirements: [
            {
        ...
        },
        {
          ...
          summary:
            'Allows individuals to withdraw consent and requires content deletion upon consent withdrawal',
          quote:
          ...
          timeframes: null,
          evidenceRequirements: [],
          removalCriteria: ['Withdrawal of consent by any individual appearing in content'],
        },
        {
        ...
        },
        {
          ...
          summary:
            'Provides DMCA takedown procedures for responding to copyright infringement reports',
          quote:
          ...
          timeframes: null,
          evidenceRequirements: [],
          removalCriteria: ['Content reported as copyright infringing through DMCA process'],
        },
      ],
      appealProcess: {
        url: 'https://onlyfans.com/transparency-center/appeals',
        summary:
          'Users may dispute account termination or content deactivation decisions through the Appeals Policy',
        steps: [
    ...
    },
    {
      ...
      policies: [
        ...
        },
        {
          ...
          reference: 'Section 12.2',
          summary:
            'Complies with applicable laws requiring proportionate measures to quickly remove illegal content when aware it is on OnlyFans',
          quote:
            'We comply with applicable laws requiring us to use proportionate measures to quickly remove illegal Content when we become aware it is on OnlyFans.',
          contentTypes: ['intimate', 'personal', 'private', 'other'],
          contentContexts: ['hacked', 'impersonation', 'relationship', 'unknown', 'other'],
        ...
        },
        {
          ...
          summary:
            'Requires users to own content or hold all rights necessary to post and monetize content on OnlyFans',
          quote:
        ...
        },
        {
          ...
          summary:
            'Requires users to secure all rights, licenses, written consents and releases for any third-party material included in content',
          quote:
            'if your Content includes or uses any third-party material, you have secured all rights, licenses, written consents and releases that are necessary for the use of such third-party property in your Content and for the subsequent use of that Content on OnlyFans and by us',
          contentTypes: ['intimate', 'personal', 'private', 'other'],
        ...
        },
        {
          ...
          reference: 'Section 16.2',
          summary:
            'Requires written, informed consent from individuals at least 18 years of age who appear in co-authored content',
          quote:
            'You warrant that each individual in Co-Authored Content you Upload is: a Creator you have tagged using the tool available on OnlyFans; or an individual at least 18 years of age whose proof of identity and whose written, informed consent you have obtained to share the Content on OnlyFans.',
          contentTypes: ['intimate', 'personal'],
          contentContexts: ['relationship', 'unknown', 'other'],
        ...
        },
        {
          ...
          reference: 'Section 16.6',
          summary:
            'Allows individuals to withdraw consent for co-authored content at any time, which may result in content deletion',
          quote:
            'Any individual(s) who appear in the Co-Authored Content may, at any time, withdraw their consent to appear in that Co-Authored Content. Co-Authored Content may be deleted where a participant withdraws consent.',
          contentTypes: ['intimate', 'personal'],
          contentContexts: ['relationship', 'other'],
          timeframes: null,
          evidenceRequirements: [],
          removalCriteria: ['Co-authored content where a participant has withdrawn consent'],
        },
        {
          id: 'of-tos-ip-infringement-warranty',
          reference: 'Section 15.1',
          summary:
            'Requires content to not infringe or violate intellectual property rights of any third party',
          quote:
            'You confirm that your Content does not infringe or violate the intellectual property rights of any third-party and that you own or have obtained all rights necessary to distribute, copy, display, publicly perform or otherwise use the Content.',
          contentTypes: ['intimate', 'personal', 'private', 'other'],
          contentContexts: ['hacked', 'impersonation', 'relationship', 'unknown', 'other'],
        ...
        },
        {
          ...
          reference: 'Section 14.2',
          summary:
            'May suspend or delete accounts and content without warning for serious or repeated breaches of Terms of Service',
          quote:
        ...
        },
        {
          ...
          summary:
            'May suspend accounts and withhold earnings when suspected unlawful or fraudulent activity is involved',
          quote:
      ...
      appealProcess: {
        url: 'https://onlyfans.com/transparency-center/appeals',
        summary:
          'Users may dispute account termination or content deactivation decisions by following the Appeals Policy',
        steps: [
      ...
      policies: [
        {
          ...
          timeframes: null,
          evidenceRequirements: [],
          removalCriteria: ['User is under 18 years of age'],
        },
        {
          id: 'of-pp-content-moderation',
          reference: 'Section 10',
          summary:
            'Provides moderation and filtration of content uploaded to OnlyFans to monitor and investigate violations',
          quote:
            'Moderation and filtration: text and content uploaded to OnlyFans; livestreaming on OnlyFans; content sent in chat messages on OnlyFans to monitor and investigate violations of our Terms of Service.',
          contentTypes: ['intimate', 'personal', 'other'],
          contentContexts: ['hacked', 'impersonation', 'relationship', 'unknown', 'other'],
          timeframes: null,
          evidenceRequirements: [],
          removalCriteria: ['Content violates Terms of Service'],
        },
        {
          id: 'of-pp-illegal-content-removal',
          reference: 'Section 10',
          summary:
            'Removes content identified as illegal and suspends or deactivates associated user accounts',
          quote:
          ...
          timeframes: null,
          evidenceRequirements: [],
          removalCriteria: ['Content is identified as illegal'],
        },
        {
          id: 'of-pp-tos-violation-removal',
          reference: 'Section 10',
          summary:
            'Removes content that violates Terms of Service and may suspend or deactivate user accounts',
          quote:
        ...
        },
        {
          ...
          timeframes: null,
          evidenceRequirements: [],
          removalCriteria: ['User has been previously banned from the platform'],
        },
        {
          id: 'of-pp-fraud-detection',
          reference: 'Section 10',
          summary:
            'Monitors transactions and systems to detect malicious, deceptive, fraudulent, or illegal activity',
          quote:
            'Monitoring transactions and company network, systems, applications, and data, to: (i) detect malicious, deceptive, fraudulent, or illegal activity to protect information security and integrity, and user safety; and (ii) respond to / investigate incidents where appropriate.',
          contentTypes: ['intimate', 'personal', 'private', 'other'],
          contentContexts: ['hacked', 'impersonation', 'relationship', 'unknown', 'other'],
          timeframes: null,
          evidenceRequirements: [],
        ...
        },
        {
          ...
          timeframes: null,
          evidenceRequirements: [],
          removalCriteria: ['Content threatens the rights and property of users or third parties'],
        },
        {
          id: 'of-pp-law-enforcement-reporting',
          reference: 'Section 10',
          summary:
            'Reports illegal activity to relevant law enforcement authorities and governmental organizations',
          quote:
            'Reporting illegal activity to relevant law enforcement authorities, other governmental authorities and non-governmental organisations.',
          contentTypes: ['intimate', 'personal', 'private', 'other'],
          contentContexts: ['hacked', 'impersonation', 'relationship', 'unknown', 'other'],
          timeframes: null,
          evidenceRequirements: [],
          removalCriteria: ['Activity is identified as illegal and reportable to authorities'],
        },
      ],
      appealProcess: null,
    },
    {
      ...
      summary:
        'Federal law signed into law on May 19, 2025, criminalizing nonconsensual intimate imagery including deepfakes and requiring covered platforms to remove such content within 48 hours of verified requests. Platforms have until May 19, 2026 to implement required notice-and-removal processes.',
      ...
      policies: [
        ...
        },
        {
          ...
          evidenceRequirements: [
            ...
            {
              description:
                'Identification and information reasonably sufficient to locate the intimate visual depiction',
        ...
        },
        {
          ...
          timeframes: {
            response: {
              ...
              unit: 'years',
              description:
                'Platform must establish notice and removal process within 1 year of enactment',
            },
            removal: null,
          },
          evidenceRequirements: [],
