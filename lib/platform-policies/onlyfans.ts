...
export const onlyfansPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2025-11-03T09:07:37.948Z",
    "policies": [
      {
  ...
  {
    "id": "onlyfans-new-1762160857948-1",
    "reference": "OF-DMCA",
    "title": "DMCA Copyright Policy",
    "summary": "OnlyFans Digital Millennium Copyright Act policy detailing copyright infringement reporting procedures, takedown processes, and intellectual property protection mechanisms.",
