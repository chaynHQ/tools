...
export const onlyfansPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2026-03-23T09:23:05.416Z",
    "policies": [
      {
    ...
    "appealProcess": {
      ...
      "steps": [
        ...
        "Dispute must be made within six months of notification to avoid waiving the right to dispute"
      ]
    }
  },
  {
  ...
  },
  {
    ...
    "summary": "Federal law enacted on May 19, 2025 (Public Law 119-12), criminalizing nonconsensual intimate imagery including AI-generated deepfakes. Requires covered platforms to implement notice-and-removal processes within 48 hours of victim requests. Criminal penalties include up to 2-3 years imprisonment. Platforms must comply by May 19, 2026.",
