...
export const onlyfansPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "summary": "Comprehensive policy covering prohibited content and behavior on OnlyFans, including restrictions on non-consensual content, harassment, illegal activities, and content moderation guidelines.",
    "url": "https://onlyfans.com/aup",
    "accessTimestamp": "2026-06-15T11:05:28.755Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "summary": "Legal terms governing the use of OnlyFans, including content ownership, security responsibilities, user eligibility requirements, and platform rules for creators and subscribers.",
  ...
  },
  {
    ...
    "summary": "Privacy policy explaining how OnlyFans collects, uses, and protects user data, including biometric data collection, international data transfers, and user rights regarding personal information.",
