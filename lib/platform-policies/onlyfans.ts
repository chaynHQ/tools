...
export const onlyfansPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "summary": "Comprehensive policy covering prohibited content and behavior on OnlyFans, including restrictions on non-consensual content, illegal activities, minors, and harmful content.",
    "url": "https://onlyfans.com/aup",
    "accessTimestamp": "2025-09-23T22:15:45.255Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "summary": "Legal terms governing the use of OnlyFans, including content ownership, user responsibilities, age verification requirements, and platform rules.",
