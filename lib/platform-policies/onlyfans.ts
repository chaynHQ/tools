...
export const onlyfansPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2025-12-08T09:09:05.986Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "summary": "Federal law enacted on May 19, 2025, criminalizing publication of non-consensual intimate imagery (NCII) including AI-generated deepfakes. Requires covered platforms to remove such content within 48 hours of victim notification. Notice-and-removal procedures must be implemented by May 19, 2026. Enforcement overseen by FTC.",
