...
export const onlyfansPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2025-09-24T14:16:06.081Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "appealProcess": {
      ...
      "summary": "Users can submit tickets through their account or email privacy@onlyfans.com for privacy-related concerns. U.S. residents have the right to appeal privacy rights decisions.",
      "steps": [
