...
export const onlyfansPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "summary": "Comprehensive policy covering prohibited content and behavior on OnlyFans, including non-consensual content, harassment, violence, and illegal activities.",
    "url": "https://onlyfans.com/aup",
    "accessTimestamp": "2025-11-10T09:06:42.079Z",
    "policies": [
      {
    ...
    "appealProcess": {
      ...
      "summary": "Users can dispute account termination or content deactivation decisions through the Appeals Policy",
      "steps": [
  ...
  },
  {
    ...
    "summary": "Legal terms governing the use of OnlyFans, including content ownership, security responsibilities, and platform rules for creators and subscribers.",
  ...
  },
  {
    ...
    "summary": "Privacy policy explaining how OnlyFans collects, uses, and protects user data, including identity verification and data sharing practices.",
