...
export const onlyfansPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2025-09-24T13:51:56.491Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "summary": "Federal law signed into law on May 19, 2025, criminalizing nonconsensual intimate imagery including AI-generated deepfakes and requiring covered platforms to remove such content within 48 hours of verified requests. Criminal provisions are effective immediately, while platforms have until May 19, 2026 to implement required notice-and-removal processes.",
