...
export const onlyfansPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2025-09-23T21:06:20.918Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "summary": "Federal law signed into law by President Trump on May 19, 2025, criminalizing nonconsensual intimate imagery including AI-generated deepfakes. Requires covered platforms to implement notice-and-removal processes within one year (by May 19, 2026) to remove such content within 48 hours of verified requests.",
