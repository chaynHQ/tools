...
export const onlyfansPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2025-09-23T20:32:21.734Z",
    "policies": [
      {
        "id": "of-terms-content-removal",
      ...
      {
        "id": "of-terms-illegal-content-removal",
      ...
      {
        "id": "of-terms-co-authored-consent",
      ...
      {
        "id": "of-terms-consent-withdrawal",
      ...
      {
        "id": "of-terms-intellectual-property",
  ...
  },
  {
    ...
    "appealProcess": {
      "url": null,
      "summary": "Appeals process available for certain U.S. State residents to challenge privacy rights decisions",
      "steps": [
  ...
  },
  {
    ...
    "summary": "Federal law enacted May 19, 2025, criminalizing nonconsensual intimate imagery including AI-generated deepfakes, requiring covered platforms to remove such content within 48 hours of notice from victims.",
