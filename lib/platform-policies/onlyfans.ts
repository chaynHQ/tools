...
export const onlyfansPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "summary": "Comprehensive policy covering prohibited content and behavior on OnlyFans, including non-consensual content, illegal activities, violence, and child exploitation.",
    "url": "https://onlyfans.com/aup",
    "accessTimestamp": "2025-11-17T09:08:11.747Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "summary": "Legal terms governing the use of OnlyFans, including content ownership, security responsibilities, prohibited content, and platform rules.",
  ...
  {
    "id": "onlyfans-new-1763370491747-0",
    "reference": "OF-DMCA",
    "title": "DMCA Copyright Policy",
    "summary": "OnlyFans' Digital Millennium Copyright Act policy covering copyright infringement reporting, takedown procedures, and content protection measures for creators.",
