...
export const onlyfansPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2025-09-23T20:40:52.977Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "appealProcess": {
      ...
      "steps": [
        "Users have six months from notification to dispute decisions",
        "Account termination or content deactivation disputes follow the Appeals Policy",
        "Creator Earnings forfeiture disputes follow the Complaints Policy",
        "Failure to dispute within six months waives the right to dispute"
      ]
    }
  },
  {
  ...
  },
  {
    ...
    "summary": "Federal law signed into law by President Trump on May 19, 2025, criminalizing nonconsensual intimate imagery including AI-generated deepfakes and requiring covered platforms to remove such content within 48 hours of verified requests. The FTC has oversight and enforcement authority. Platforms have until May 19, 2026 to implement required notice-and-removal processes.",
