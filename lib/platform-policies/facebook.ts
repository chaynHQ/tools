...
export const facebookPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2026-02-02T09:19:34.037Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "policies": [
      ...
      },
      {
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Content targets individual via personal surfaces (inbox or profiles)",
  ...
  },
  {
    ...
    "appealProcess": {
      ...
      "steps": [
        ...
        "For copyright claims, submit a DMCA counter-notification if you believe content was wrongly removed",
  ...
  },
  {
    ...
    "appealProcess": {
      ...
      "summary": "Users can get help with adult sexual exploitation issues through Meta's Help Center",
      "steps": [
        "Visit the Help Center for adult sexual exploitation guidance",
        "Learn what actions can be taken if content violates Community Standards"
      ]
    }
  },
  {
  ...
  {
    "id": "facebook-new-1770023974037-0",
    "reference": "META-SEXUAL-SOLICITATION-2025",
    "title": "Adult Sexual Solicitation and Sexually Explicit Language Policy",
    "summary": "Policy addressing sexual solicitation, sexually explicit language, and content that facilitates sexual encounters, with specific provisions for age-restricted content.",
    ...
    "policies": [
      {
        ...
        "summary": "Prohibits content that engages in sexual solicitation by offering, asking or providing methods of contact for sharing of nude imagery",
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Content offers, asks or provides methods of contact for sharing of nude imagery",
          "Content engages in sexual solicitation involving sharing of intimate images or videos"
        ]
      },
      {
        "id": "meta-sexual-solicitation-pornographic-material",
        "reference": "Pornographic material acquisition",
        ...
        "removalCriteria": [
          ...
          "Content contains usernames or links to pornographic websites"
        ]
      },
      {
        "id": "meta-sexual-solicitation-explicit-language",
        "reference": "Sexually explicit language",
        "summary": "Prohibits sexually explicit language that uses explicit or graphic detail about intimate body parts, states of arousal, or sexual encounters",
        ...
        "removalCriteria": [
          ...
          "Content is not shared in humorous, satirical context or as sexual cursing"
        ]
      }
    ],
    "appealProcess": null
