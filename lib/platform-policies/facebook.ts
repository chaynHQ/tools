...
export const facebookPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "policies": [
      ...
      {
        "id": "takedown-act-good-faith-removal-immunity",
        "reference": "Section 3(a)(4)",
        "summary": "Establishes that platforms will not face liability for good faith removal of content reasonably believed to be a nonconsensual intimate visual depiction, supporting proactive removal in response to takedown requests",
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Material is claimed to be a nonconsensual intimate visual depiction",
          "Facts or circumstances make the unlawful publishing apparent"
        ]
      },
      {
        "id": "takedown-act-ftc-enforcement",
        "reference": "Section 3(b)(1)",
        "summary": "Establishes that a platform's failure to reasonably comply with the notice and takedown obligations constitutes an unfair or deceptive act or practice, enforceable by the Federal Trade Commission",
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Platform fails to reasonably comply with notice and takedown obligations"
        ]
      }
    ],
    "appealProcess": null
  ...
  },
  {
    ...
    "policies": [
      ...
      {
        "id": "meta-tos-account-repeated-ip-infringement",
        "reference": "Section 4.2",
        "summary": "Provides authority to disable or delete accounts that repeatedly infringe other people's intellectual property rights",
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Repeated infringement of another person's intellectual property rights",
          "Legal requirement to disable or delete the account"
        ]
      },
      {
        "id": "meta-tos-account-compromised",
        "reference": "Section 4.2",
        "summary": "Provides authority to disable or delete accounts where there is evidence the account has been used without the owner's permission and ownership cannot be confirmed",
        "quote": "We may disable or delete your account if after registration your account is not confirmed, your account is unused and remains inactive for an extended period of time, or if we detect someone may have used it without your permission and we are unable to confirm your ownership of the account.",
        "contentTypes": [
          "intimate",
          "personal",
          "private",
  ...
  },
  {
    ...
    "policies": [
      ...
      {
        "id": "meta-copyright-reporting-process",
        "reference": "Reporting copyright infringement",
        "summary": "Requires that only the copyright owner or their authorized representative may submit a copyright infringement report, and outlines the ways a report can be filed",
        ...
        "evidenceRequirements": [
          {
            "description": "Reporter must be the copyright owner or an authorized representative",
            "example": "Providing identification of the rights holder or authorization to act on their behalf",
            "reason": "To confirm the reporter has standing to request removal"
          },
          {
            "description": "A complete copyright claim must be included when contacting the designated agent directly",
            "example": "Identification of the copyrighted work and the infringing material, plus contact details",
            "reason": "To enable Meta to evaluate and process the infringement claim"
          }
        ],
        "removalCriteria": [
          "Valid report submitted by the copyright owner or authorized representative",
          "Report includes a complete copyright claim"
        ]
      },
      {
        "id": "meta-fraudulent-reports",
        "reference": "Reporting copyright infringement",
        "summary": "Warns that intentionally submitting misleading or fraudulent copyright infringement reports may result in account termination and legal liability",
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Report is found to be intentionally misleading or fraudulent"
        ]
      }
    ],
    "appealProcess": {
  ...
  },
  {
    ...
    "policies": [
      ...
      {
        "id": "meta-ase-third-party-survivor-identification-trusted-partner",
        "reference": "Adult Sexual Exploitation Policy",
        "summary": "May remove content shared by a third party that identifies survivors of sexual assault when reported by an authorized representative or Trusted Partner",
        "quote": "We may also enforce on content shared by a third party that identifies survivors of sexual assault when reported by an authorized representative or Trusted Partner.",
        "contentTypes": [
          "personal",
          "private",
          "other"
        ...
        "evidenceRequirements": [
          {
            "description": "Report from an authorized representative or Trusted Partner of the survivor",
            "example": "A legal representative, advocate, or designated Trusted Partner reporting on behalf of the survivor",
            "reason": "To confirm the survivor's lack of consent to being identified when the survivor cannot report directly"
          }
        ],
        "removalCriteria": [
          "Content identifies survivors of sexual assault",
  ...
  },
  {
    ...
    "policies": [
      ...
      },
      {
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Content or account found to violate Meta's terms or policies",
          "Content reported as harmful or unlawful",
          "Content threatens user life, health, well-being or integrity"
        ]
      },
      {
        "id": "meta-privacy-law-enforcement-sharing",
        "reference": "Section 19 - Sharing information with others including law enforcement to respond to legal requests",
        "summary": "Shares account and content information with law enforcement and others to respond to legal requests and promote safety",
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Valid legal request received from law enforcement or other authority",
          "Required to comply with applicable law",
          "Necessary to promote safety, security and integrity"
        ]
      },
      {
        "id": "meta-privacy-required-by-law",
        "reference": "Section 19 - Processing information when required by law",
        "summary": "Discloses account and content information when legally compelled, such as by a valid search warrant",
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Valid legal obligation to disclose information",
          "Receipt of a valid legal request such as a search warrant"
        ]
      }
    ],
    "appealProcess": null
  ...
  {
    "id": "facebook-new-1783166738073-0",
    "reference": "META-COPYRIGHT-TRADEMARK-TC",
    ...
    "policies": [
      {
        ...
        "reference": "META-COPYRIGHT-TRADEMARK-TC",
        "summary": "Prohibits ads that infringe upon or violate the intellectual property rights of any third party, including copyright, trademark, or other legal rights.",
        "quote": "Ads may not contain content that infringes upon or violates the intellectual property rights of any third party, including copyright, trademark or other legal rights.",
        "contentTypes": [
          "personal",
          "other"
        ],
        ...
        "evidenceRequirements": [
          {
            "description": "A report from the affected intellectual property rights holder",
            "example": "Submission via the Intellectual Property Help Center",
            "reason": "Meta states it cannot know with certainty whether an ad infringes on someone's rights without a report from the affected rights holder"
          }
        ],
        "removalCriteria": [
          "The ad infringes upon or violates the intellectual property rights of a third party",
          "The ad has been reported to Meta by an intellectual property rights holder",
          "There are signs the ad may infringe the rights of a third party"
        ]
      },
      {
        "id": "meta-copyright-trademark-unauthorized-use",
        "reference": "META-COPYRIGHT-TRADEMARK-TC",
        "summary": "Prohibits ads and destination pages from using Meta's copyrights, trademarks, or confusingly similar marks without express permission.",
        "quote": "All other ads and destination (landing) pages must not use our copyrights, trademarks, or any confusingly similar marks, except as expressly permitted by the Meta Brand Resource Center, or with our prior written permission.",
        "contentTypes": [
          "other"
        ],
        "contentContexts": [
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "The ad or landing page uses Meta's copyrights, trademarks, or confusingly similar marks",
          "Use is not expressly permitted by the Meta Brand Resource Center or prior written permission"
        ]
      }
    ],
    "appealProcess": null
