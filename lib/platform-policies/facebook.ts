...
export const facebookPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2025-10-06T09:09:29.936Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "appealProcess": {
      "url": null,
      "summary": "Users can request review of content removal or account actions, unless doing so may expose Meta or others to legal liability, harm the community, compromise system integrity, or is prohibited for legal reasons",
      "steps": [
        ...
        "Review conducted unless serious or repeated violations occurred"
      ]
    }
  },
  {
    ...
    "appealProcess": {
      ...
      "summary": "Users can appeal content decisions through Facebook's Support Inbox and request another review if they disagree with the initial decision",
      "steps": [
