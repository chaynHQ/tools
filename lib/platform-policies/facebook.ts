...
export const facebookPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2026-04-27T09:49:33.492Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "appealProcess": {
      ...
      "steps": [
        ...
        "Contact platform if account was disabled by mistake",
        "Review is subject to exceptions for serious violations, repeated violations, legal liability concerns, or technical limitations"
      ]
    }
  },
  {
  ...
  },
  {
    ...
    "summary": "Policy addressing bullying, harassment, and targeted attacks, including protections for private individuals and provisions for image-based abuse. Updated January 22, 2025.",
    ...
    "policies": [
      ...
      {
        "id": "meta-harassment-mass-harassment-heightened-risk",
        "reference": "Bullying and harassment through pages, groups, events and messages",
        "summary": "Prohibits directed mass harassment targeting individuals at heightened risk of offline harm",
        ...
        "removalCriteria": [
          ...
          "Target is a human rights defender, minor, victim of violent events, opposition figure, election official, government dissident, ethnic/religious minority in conflict zones, or member of at-risk group"
        ]
      },
      {
        "id": "meta-harassment-mass-harassment-personal-surfaces",
        "reference": "Bullying and harassment through pages, groups, events and messages",
        "summary": "Prohibits targeting any individual via personal surfaces with bullying content or objectionable content based on protected characteristics",
        "quote": "Targeting any individual via personal surfaces, such as inbox or profiles, with: Content that violates the bullying and harassment policies for private individuals or, Objectionable content that is based on a protected characteristic",
        "contentTypes": [
          "intimate",
          "personal",
          "private",
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Content targets individual via personal surfaces (inbox, profiles)",
          "Content violates bullying and harassment policies for private individuals",
          "Content is objectionable and based on a protected characteristic"
        ]
      }
    ],
    "appealProcess": null
  },
  {
    ...
    "appealProcess": {
      "url": null,
      "summary": "Users can appeal copyright removals by following instructions provided in removal notifications, including DMCA counter-notifications where applicable",
      "steps": [
  ...
  },
  {
    ...
    "summary": "Specific policy addressing non-consensual intimate imagery, sextortion, and other forms of adult sexual exploitation including detailed provisions for NCII removal. Updated October 31, 2025.",
    ...
    "policies": [
      ...
      },
      {
        ...
        "reference": "Adult Sexual Exploitation Policy",
        "summary": "Prohibits promoting, threatening to share, or offering to make non-consensual intimate imagery or kissing imagery through applications, services, or instructions",
        "quote": "Promoting, threatening to share, or offering to make NCII or kissing imagery through applications or services (including AI), or instructions, even if there is no commercial or non-commercial imagery shared in the content (sometimes referred to as \"nudify\" apps or \"AI kissing\" apps).",
        "contentTypes": [
          "intimate",
          "other"
        ],
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Promoting creation of non-consensual intimate imagery or kissing imagery",
          "Threatening to share non-consensual intimate imagery or kissing imagery",
          "Offering applications, services, or instructions for creating such imagery"
        ]
      },
      {
  ...
  },
  {
    ...
    "policies": [
      ...
      },
      {
        ...
        "reference": "Third-Party Intellectual Property Infringement",
        "summary": "Removes content that infringes on trademark rights",
      ...
      },
      {
        ...
        "reference": "Third-Party Intellectual Property Infringement",
        "summary": "Prohibits the sale or promotion of counterfeit goods",
        ...
        "evidenceRequirements": [
          {
            "description": "Report from rights holder or authorized representative",
            "example": "Documentation showing authentic product ownership or authorization",
            "reason": "To verify legitimate brand ownership before removing counterfeit content"
          }
        ],
        "removalCriteria": [
          "Content involves sale of counterfeit goods",
          "Content involves promotion of counterfeit goods",
          "Report received from rights holder or authorized representative"
        ]
      },
      {
        ...
        "reference": "Third-Party Intellectual Property Infringement",
        "summary": "Removes content showing false affiliation with brands",
        ...
        "evidenceRequirements": [
          {
            "description": "Report from rights holder or authorized representative",
            "example": "Brand ownership documentation or authorization to act on behalf of brand",
            "reason": "To verify legitimate brand ownership before removing false affiliation content"
          }
        ],
        "removalCriteria": [
          "Content shows false affiliation with brand",
          "Report received from rights holder or authorized representative"
        ]
      },
      {
      ...
      {
        "id": "meta-ip-suspected-counterfeit-promotion",
        "reference": "Third-Party Intellectual Property Infringement",
        "summary": "Removes content with signs of selling or promoting counterfeit goods",
      ...
      },
      {
        ...
        "reference": "Third-Party Intellectual Property Infringement",
        "summary": "Removes content linking to websites selling suspected counterfeit goods",
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Content contains off-platform links to websites selling suspected counterfeit goods",
          "Content contains off-platform links to websites promoting suspected counterfeit goods"
        ]
      },
      {
        "id": "meta-ip-previously-reported-counterfeits",
        "reference": "Third-Party Intellectual Property Infringement",
        "summary": "Removes content selling suspected counterfeits similar to previously reported items",
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Content sells suspected counterfeit goods identical to previously reported counterfeits",
          "Content sells suspected counterfeit goods highly similar to previously reported counterfeits",
          "Content promotes suspected counterfeit goods identical to previously reported counterfeits",
          "Content promotes suspected counterfeit goods highly similar to previously reported counterfeits"
        ]
      },
      {
  ...
  },
  {
    ...
    "summary": "Comprehensive privacy policy covering data collection, use, sharing, and user rights across Meta platforms, effective December 16, 2025 with AI interaction provisions.",
