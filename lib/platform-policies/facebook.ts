...
export const facebookPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2026-04-13T09:38:19.398Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "appealProcess": {
      "url": null,
      "summary": "Users can appeal copyright removals by following instructions in Meta's notification message, including DMCA counter-notification procedures where applicable",
      "steps": [
    ...
    "policies": [
      {
        ...
        "removalCriteria": [
          ...
          "Includes digitally created or AI-generated imagery",
      ...
      },
      {
        ...
        "reference": "Adult Sexual Exploitation Policy",
        "summary": "Prohibits secretly taken non-commercial imagery focusing on intimate body parts or sexual activity that is shared with intent to mock, sexualize or reveal identity",
        ...
        "removalCriteria": [
          ...
          "Shared with intent to mock, sexualize or reveal identity of the person depicted"
        ]
      },
      {
  ...
  },
  {
    ...
    "summary": "Comprehensive privacy policy covering data collection, use, sharing, and user rights across Meta platforms, effective December 16, 2025.",
