...
export const facebookPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2026-04-20T09:41:21.757Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "appealProcess": {
      ...
      "steps": [
        "Appeal the decision through Meta's standard appeals process first",
        "If unsatisfied with the outcome, submit case to the Oversight Board",
  ...
  },
  {
    ...
    "appealProcess": {
      "url": null,
      "summary": "Users can request review of content removal or account actions unless doing so would expose Meta or others to legal liability, harm the community, compromise system integrity, or where prohibited for legal or technical reasons",
      "steps": [
  ...
  },
  {
    ...
    "appealProcess": {
      ...
      "steps": [
        ...
        "Learn what actions can be taken if content goes against Community Standards"
      ]
    }
  },
  {
  ...
  },
  {
    ...
    "appealProcess": {
      "url": null,
      "summary": "Users can appeal copyright removals by following instructions in the notification message, including DMCA counter-notification procedures for eligible cases",
      "steps": [
        ...
        "Submit an appeal using instructions provided in the notification message",
  ...
  },
  {
    ...
    "policies": [
      ...
      },
      {
        ...
        "summary": "Removes accounts that repeatedly post content infringing intellectual property rights",
    ...
    "appealProcess": {
      "url": null,
      "summary": "Users can contact rights owners directly or submit appeals through notifications received after content removal",
      "steps": [
        "Receive notification from Meta about content removal including rights owner details",
  ...
  },
  {
    ...
    "summary": "Comprehensive privacy policy covering data collection, use, sharing, and user rights across Meta platforms, with major updates effective December 16, 2025 regarding AI interactions.",
