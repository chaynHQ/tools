...
export const facebookPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2026-03-02T09:18:45.799Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "appealProcess": {
      "url": null,
      "summary": "Users can appeal copyright removals by following instructions in the notification message, including DMCA counter-notification procedures where applicable",
      "steps": [
        ...
        "Submit an appeal using instructions provided in the removal notification message",
  ...
  {
    "id": "facebook-new-1772443125799-0",
    "reference": "META-SAFETY-NCII-2025",
    "title": "Intimate Image Abuse and Sextortion Safety Center",
    "summary": "Dedicated safety resource providing information on non-consensual intimate imagery, sextortion prevention, and reporting tools including StopNCII.org integration.",
    ...
    "policies": [
      ...
      {
        "id": "meta-exploitative-content-prohibition",
        ...
        "removalCriteria": [
          ...
          "Content involves sharing someone's intimate images",
          "Content involves threatening to share someone's intimate images"
        ]
      },
      {
        "id": "meta-private-images-reporting",
        "reference": "Our policies and enforcement",
        "summary": "Provides dedicated reporting option for private images being shared without consent",
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Someone is sharing private images without consent"
        ]
      },
      {
        "id": "meta-24-7-review",
        "reference": "How to report threats and intimate images",
        "summary": "Reviews reports 24/7 in more than 70 languages and takes action on violating content and behavior",
        ...
        "removalCriteria": [
          ...
          "Behavior violates platform policies"
        ]
      }
    ],
    "appealProcess": null
