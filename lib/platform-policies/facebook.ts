...
export const facebookPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2025-12-22T09:10:05.601Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "appealProcess": {
      ...
      "steps": [
        ...
        "Review requests are not available for serious or repeated violations",
        "Review requests may be restricted due to legal liability, community safety, technical limitations, or legal prohibitions"
      ]
    }
  },
  {
    ...
    "appealProcess": {
      ...
      "summary": "Users can get help with adult nudity and sexual activity violations through Meta's Help Center",
      "steps": [
  ...
  },
  {
    ...
    "appealProcess": {
      ...
      "steps": [
        ...
        "Submit DMCA counter-notification if content was removed under DMCA procedures",
  ...
  {
    "id": "facebook-new-1766394605600-0",
    "reference": "META-SEXUAL-SOLICITATION-2025",
    "title": "Adult Sexual Solicitation and Sexually Explicit Language Policy",
    "summary": "Policy addressing sexual solicitation, pornographic content requests, and sexually explicit language with specific provisions for content moderation and age restrictions.",
    ...
    "policies": [
      {
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Content offers, asks or provides methods of contact for sharing nude imagery",
          "Content engages in sexual solicitation involving nude imagery or intimate videos"
        ]
      },
      {
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Content asks for or offers pornographic material",
      ...
      },
      {
        ...
        "removalCriteria": [
          ...
          "Content uses explicit language about states of arousal",
          "Content uses explicit language about intimate encounters",
          "Content is not shared in humorous, satirical context or as cursing"
        ]
      }
    ],
    "appealProcess": {
