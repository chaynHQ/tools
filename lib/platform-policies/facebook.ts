...
export const facebookPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2025-09-29T09:09:03.481Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "appealProcess": {
      ...
      "steps": [
        ...
        "Review conducted unless legal, safety, or technical limitations prevent it"
      ]
    }
  },
  {
    ...
    "appealProcess": {
      ...
      "steps": [
        "Report content through universal reporting entry point",
  ...
  },
  {
    ...
    "appealProcess": {
      "url": null,
      "summary": "Users can request another review if they disagree with enforcement decisions through the Support Inbox notification system",
      "steps": [
  ...
  },
  {
    ...
    "appealProcess": {
      ...
      "steps": [
        ...
        "Provide additional information during the appeal",
        "Receive final response after re-review in Support Inbox"
      ]
    }
  },
  ...
  },
  {
    ...
    "summary": "Comprehensive privacy policy covering data collection, use, sharing, and user rights across Meta platforms, with recent updates effective June 16, 2025 and additional regional updates throughout 2025.",
