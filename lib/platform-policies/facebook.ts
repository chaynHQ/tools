...
export const facebookPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2025-10-13T09:08:57.653Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "appealProcess": {
      ...
      "summary": "Users can appeal content removal decisions through Facebook's Support Inbox system with multiple review stages",
      "steps": [
  ...
  },
  {
    ...
    "appealProcess": {
      ...
      "steps": [
        ...
        "Instructions for appeals will be provided in the removal notification message"
      ]
    }
  },
  {
    ...
    "appealProcess": {
      ...
      "steps": [
        ...
        "Meta provides final response after re-review"
      ]
    }
  },
  {
    ...
    "appealProcess": {
      ...
      "steps": [
        ...
        "Submit a report as rights holder or authorized representative",
        "Provide documentation of ownership or authorization"
      ]
    }
  },
  {
    ...
    "summary": "Comprehensive privacy policy covering data collection, use, sharing, and user rights across Meta platforms, effective June 16, 2025. Updated to include AI data usage provisions and enhanced transparency requirements.",
