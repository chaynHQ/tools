...
export const facebookPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2026-04-06T09:31:51.854Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "appealProcess": {
      ...
      "steps": [
        "Submit appeal through platform's internal appeals process first",
        "If unsatisfied with internal decision, appeal to the Oversight Board",
        "Oversight Board reviews case and makes binding decision"
      ]
    }
  },
  {
    ...
    "appealProcess": {
      ...
      "steps": [
        "Content removal notification will be provided with explanation",
        "Options to request another review will be included unless violations are serious or repeated",
        "Review requests may be restricted where legal liability, community harm, or technical limitations exist"
      ]
    }
  },
  {
  ...
  },
  {
    ...
    "appealProcess": {
      ...
      "steps": [
        ...
        "For DMCA cases, file a counter-notification following instructions provided in Meta's message",
        "Appeals are considered under the repeat infringer policy if content is restored"
      ]
    }
  },
  {
    ...
    "policies": [
      ...
      },
      {
        ...
        "reference": "Adult Sexual Exploitation Policy",
        "summary": "Prohibits promoting, threatening to share, or offering to make non-consensual intimate imagery through applications, services, or instructions",
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Promoting creation of non-consensual intimate imagery",
