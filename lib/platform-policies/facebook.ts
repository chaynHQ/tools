...
export const facebookPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2025-09-25T14:47:51.600Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "appealProcess": {
      ...
      "steps": [
        "Request review of content removal decision if available",
        "Request review of account suspension or termination decision if available",
        "Review may not be available in cases involving legal liability, community harm, system integrity issues, or legal prohibitions"
      ]
    }
  },
  {
    ...
    "appealProcess": {
      ...
      "steps": [
        ...
        "If disagreeing with decision, request another review through appeal option in Support Inbox",
  ...
  },
  {
    ...
    "appealProcess": {
      "url": null,
      "summary": "Users can appeal enforcement decisions through the Support Inbox and request another review if they disagree with the decision",
      "steps": [
  ...
  },
  {
    ...
    "appealProcess": {
      ...
      "steps": [
        ...
        "Access more details in the Support Inbox",
  ...
  },
  {
    ...
    "appealProcess": {
      ...
      "steps": [
        ...
        "Provide documentation of copyright ownership or authorization"
      ]
    }
  },
  {
    ...
    "summary": "Comprehensive privacy policy covering data collection, use, sharing, and user rights across Meta platforms, with recent updates effective June 16, 2025 addressing AI training and data usage transparency.",
    ...
    "policies": [
      ...
      },
      {
        ...
        "quote": "We process information we have associated with you and apply automated processing techniques and, in some instances, conduct manual (human) review to: Verify accounts and activity, Find and address violations of our terms or policies.",
        "contentTypes": [
          "personal",
          "private",
          "other"
  ...
  {
    "id": "facebook-new-1758811671600-0",
    "reference": "META-IP-HELP-2025",
    "title": "Intellectual Property Across Meta Platforms",
    "summary": "Comprehensive help center guide covering intellectual property rights, copyright and trademark protections, and reporting mechanisms across all Meta platforms.",
    ...
    "policies": [
      {
        ...
        "removalCriteria": [
          ...
          "Content includes protected original expression such as images"
        ]
      },
      {
        "id": "meta-ip-trademark-prohibition",
        "reference": "Trademark",
        "summary": "Prohibits content that infringes trademark rights, including unauthorized use of brand names, logos, or other distinguishing marks",
        "quote": "A trademark is a word, slogan, symbol or design (example: brand name, logo) that distinguishes the products or services offered by one person, group or company from another. Generally, trademark law seeks to prevent confusion among consumers about who provides or is affiliated with a product or service.",
        "contentTypes": [
          "personal",
          "other"
        ],
        ...
        "removalCriteria": [
          ...
          "Unauthorized use of trademarks, brand names, or logos"
        ]
      },
      {
        "id": "meta-ip-repeat-infringer-policy",
        "reference": "Repeat Intellectual Property Infringer Policy",
        "summary": "Prohibits repeatedly posting content that infringes intellectual property rights and may result in account restrictions or disability",
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Repeatedly posting content that infringes intellectual property rights",
    ...
    "appealProcess": {
      ...
      "steps": [
        ...
        "Review the notification which may include name and email of rights owner who made the report",
