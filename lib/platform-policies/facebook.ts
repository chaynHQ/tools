...
export const facebookPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2025-11-24T09:08:38.633Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "appealProcess": {
      "url": null,
      "summary": "Users can request review of content removal decisions unless violations are serious or repeated, or legal restrictions apply",
      "steps": [
        ...
        "Review may be restricted due to legal liability, community safety, or technical limitations"
      ]
    }
  },
  {
    ...
    "appealProcess": {
      ...
      "summary": "Users can get help with adult nudity and sexual activity issues through Meta's Help Center",
      "steps": [
        "Visit the Help Center for guidance on reporting content that violates Community Standards"
      ]
    }
  },
  {
  ...
  },
  {
    ...
    "policies": [
      ...
      },
      {
        ...
        "reference": "Third-Party Intellectual Property Infringement",
        "summary": "Removes content that engages in trademark infringement",
        ...
        "evidenceRequirements": [
          {
            "description": "Report from rights holder or authorized representative",
            "example": "Trademark ownership documentation or authorization to act on behalf of rights holder",
            "reason": "To verify legitimate ownership of trademark before removal"
          }
        ],
        "removalCriteria": [
      ...
      {
        "id": "meta-ip-counterfeit-goods",
        "reference": "Third-Party Intellectual Property Infringement",
        "summary": "Removes content that sells or promotes counterfeit goods",
        "quote": "Upon receipt of a report from a rights holder or an authorized representative, we will remove or restrict content that engages in: The sale or promotion of counterfeit goods",
        "contentTypes": [
          "other"
        ],
        "contentContexts": [
        ...
        "evidenceRequirements": [
          {
            "description": "Report from rights holder or authorized representative",
            "example": "Brand ownership documentation or authorization to act on behalf of brand owner",
            "reason": "To verify legitimate brand ownership before removal of counterfeit content"
          }
        ],
        "removalCriteria": [
          "Content sells counterfeit goods",
          "Content promotes counterfeit goods",
          "Report received from rights holder or authorized representative"
        ]
      },
      {
        ...
        "reference": "Third-Party Intellectual Property Infringement",
        "summary": "Removes content that falsely affiliates with brands",
        ...
        "evidenceRequirements": [
          {
            "description": "Report from rights holder or authorized representative",
            "example": "Brand ownership documentation or authorization to act on behalf of brand owner",
            "reason": "To verify legitimate brand ownership before removal of falsely affiliated content"
          }
        ],
        "removalCriteria": [
          "Content falsely affiliates with brand",
          "Report received from rights holder or authorized representative"
        ]
      },
      {
        "id": "meta-ip-other-violations",
        "reference": "Third-Party Intellectual Property Infringement",
        "summary": "Removes content that infringes or violates intellectual property rights or other proprietary rights",
        ...
        "evidenceRequirements": [
          {
            "description": "Report from rights holder or authorized representative",
            "example": "Documentation of intellectual property or proprietary rights ownership",
            "reason": "To verify legitimate ownership of intellectual property or proprietary rights before removal"
          }
        ],
        "removalCriteria": [
          "Content infringes intellectual property rights",
          "Content violates proprietary rights",
          "Report received from rights holder or authorized representative"
        ]
      },
      {
      ...
      {
        "id": "meta-ip-suspected-counterfeit-signs",
        "reference": "Third-Party Intellectual Property Infringement",
        "summary": "Removes content that contains signs suggesting the sale or promotion of counterfeit branded goods",
        "quote": "We also remove content that: Contains signs that suggest the content is selling or promoting counterfeits of branded goods",
        "contentTypes": [
          "other"
        ],
        "contentContexts": [
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Content contains signs suggesting sale of counterfeit branded goods",
          "Content contains signs suggesting promotion of counterfeit branded goods"
        ]
      },
      {
        "id": "meta-ip-counterfeit-links",
        "reference": "Third-Party Intellectual Property Infringement",
        "summary": "Removes content that contains off-platform links to websites dedicated to the sale or promotion of suspected counterfeit goods",
        "quote": "We also remove content that: Contains off-platform links to websites dedicated to the sale or promotion of suspected counterfeit goods",
        "contentTypes": [
          "other"
        ],
        "contentContexts": [
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Content contains off-platform links to websites dedicated to sale of suspected counterfeit goods",
          "Content contains off-platform links to websites dedicated to promotion of suspected counterfeit goods"
        ]
      },
      {
        "id": "meta-ip-suspected-counterfeit-similar",
        "reference": "Third-Party Intellectual Property Infringement",
        "summary": "Removes content that sells or promotes suspected counterfeit goods identical or highly similar to previously reported counterfeit content",
        "quote": "We also remove content that: Sells or promotes suspected counterfeit goods that are identical or highly similar to content that has been previously reported as counterfeit by a rightsholder",
        "contentTypes": [
          "other"
        ],
        "contentContexts": [
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Content sells suspected counterfeit goods identical to previously reported counterfeit content",
          "Content sells suspected counterfeit goods highly similar to previously reported counterfeit content",
          "Content promotes suspected counterfeit goods identical to previously reported counterfeit content",
          "Content promotes suspected counterfeit goods highly similar to previously reported counterfeit content"
        ]
      },
      {
    ...
    "appealProcess": {
      ...
      "summary": "Users can report intellectual property violations through Meta's Intellectual Property Help Center",
      "steps": [
        "Visit the Intellectual Property Help Center",
        "Submit a report as a rights holder or authorized representative",
        "Provide documentation of intellectual property ownership or authorization"
      ]
    }
  },
  {
    ...
    "policies": [
      {
        ...
        "reference": "Section 19 - Promoting safety, integrity and security on and across the Meta Products",
  ...
  {
    "id": "facebook-new-1763975318633-0",
    "reference": "META-SEXUAL-SOLICITATION-2025",
    "title": "Adult Sexual Solicitation and Sexually Explicit Language Policy",
    "summary": "Policy addressing sexual solicitation, explicit language, and coordination of sexual encounters, with specific provisions for preventing exploitation and trafficking.",
    "url": "https://transparency.meta.com/policies/community-standards/sexual-solicitation/",
    "accessTimestamp": "2025-11-24T09:08:38.633Z",
    "policies": [
      {
        "id": "meta-sexual-solicitation-nude-imagery",
        "reference": "Sexual Solicitation - Sharing of nude imagery",
        "summary": "Prohibits offering, asking for, or providing contact methods for sharing nude imagery including sexual videos",
        "quote": "Content that engages in sexual solicitation by, offering, asking or providing methods of contact for sexual encounters such as: Sharing of nude imagery (such as nudes, sex videos)",
        "contentTypes": [
          "intimate"
        ],
        "contentContexts": [
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Content offers sharing of nude imagery",
          "Content asks for sharing of nude imagery",
          "Content provides contact methods for sharing nude imagery"
        ]
      },
      {
        "id": "meta-sexual-solicitation-pornographic-material",
        "reference": "Sexual Solicitation - Pornographic material",
        "summary": "Prohibits asking for, offering, or providing contact methods to acquire pornographic material, or containing usernames or links to pornographic websites",
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Content asks for pornographic material",
          "Content offers pornographic material",
          "Content provides contact methods to acquire pornographic material",
          "Content contains usernames to pornographic websites",
          "Content contains links to pornographic websites"
        ]
      },
      {
        "id": "meta-sexual-solicitation-explicit-language",
        "reference": "Sexual Solicitation - Sexually explicit language",
        "summary": "Prohibits sexually explicit language that uses graphic detail about intimate body parts, states of arousal, or sexual encounters",
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Content uses explicit or graphic detail about intimate body parts",
          "Content uses explicit or graphic detail about states of arousal",
          "Content uses explicit or graphic detail about sexual encounters",
          "Content is not shared in humorous or satirical context",
          "Content is not sexual cursing"
        ]
      }
    ],
    "appealProcess": {
      "url": "https://www.facebook.com/help/263149623790594?ref=tc",
      "summary": "Users can get help with adult sexual solicitation and sexually explicit language violations through Meta's Help Center",
      "steps": [
        "Visit the Help Center for guidance on reporting violations",
        "Learn what actions can be taken for content that goes against Community Standards"
      ]
    }
  }
],
