...
export const facebookPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2026-05-11T10:17:09.800Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "appealProcess": {
      ...
      "summary": "Users can appeal content decisions to the Oversight Board for independent review",
      "steps": [
        "Appeal the content decision through Meta's internal process first",
        "If unsatisfied with the result, submit case to the Oversight Board",
        "Oversight Board reviews the case independently",
        "Board makes binding decision on content restoration or removal"
      ]
    }
  },
  {
    ...
    "appealProcess": {
      ...
      "steps": [
        ...
        "Contact platform if account has been disabled by mistake"
      ]
    }
  },
  {
    ...
    "policies": [
      ...
      },
      {
        ...
        "removalCriteria": [
          ...
          "Target is a human rights defender, minor, victim of violent events, opposition figure, election official, government dissident, ethnic/religious minority in conflict zone, or member of at-risk group"
        ]
      },
      {
        "id": "meta-harassment-mass-harassment-personal-surfaces",
        "reference": "Bullying and harassment through pages, groups, events and messages",
        "summary": "Prohibits targeting any individual via personal surfaces with content that violates bullying policies or objectionable content based on protected characteristics",
  ...
  },
  {
    ...
    "appealProcess": {
      "url": null,
      "summary": "Users can appeal copyright removal decisions by following up with rights owners directly or submitting appeals through Meta's notification system",
      "steps": [
        ...
        "Submit an appeal using instructions provided in Meta's notification message",
    ...
    "policies": [
      ...
      },
      {
        ...
        "removalCriteria": [
          ...
          "Offering applications, services, or instructions for creating non-consensual intimate imagery"
        ]
      },
      {
        "id": "meta-ase-creepshots",
        "reference": "Adult Sexual Exploitation Policy",
        "summary": "Prohibits secretly taken non-commercial imagery focusing on intimate body parts or sexual activity that is shared to mock, sexualize or reveal identity",
        ...
        "removalCriteria": [
          ...
          "Content shared with intent to mock, sexualize or reveal identity"
        ]
      },
      {
  ...
  },
  {
    ...
    "summary": "Comprehensive privacy policy covering data collection, use, sharing, and user rights across Meta platforms, with new provisions for AI interaction data usage effective December 16, 2025.",
    "url": "https://www.facebook.com/privacy/policy",
    "accessTimestamp": "2026-05-11T10:17:09.800Z",
    "policies": [
      {
        "id": "meta-privacy-safety-security-updated",
        "reference": "Section 19 - Promoting safety, integrity and security",
        "summary": "Prohibits harmful or unlawful behavior and removes content reported for violations through automated and manual review processes",
        ...
        "removalCriteria": [
          ...
          "Content is reported to the platform"
        ]
      },
      {
        "id": "meta-privacy-legal-requests-updated",
      ...
      {
        "id": "meta-privacy-account-verification-updated",
        "reference": "Section 19 - Promoting safety, integrity and security",
  ...
  {
    "id": "facebook-new-1778494629800-0",
    "reference": "META-SEXUAL-SOLICITATION-2025",
    "title": "Adult Sexual Solicitation and Sexually Explicit Language Policy",
    "summary": "Policy addressing sexual solicitation and explicit language, with specific provisions for preventing facilitation of non-consensual sexual acts and trafficking.",
    ...
    "policies": [
      {
        ...
        "summary": "Prohibits content that asks for, offers or provides methods of contact for sharing nude imagery including intimate photos and videos",
        ...
        "removalCriteria": [
          ...
          "Content provides methods of contact for sharing nude imagery"
        ]
      },
      {
        "id": "meta-sexual-solicitation-pornographic-material",
        "reference": "Pornographic Material",
        "summary": "Prohibits content that asks for, offers or provides methods of contact to acquire pornographic material, or contains usernames or links to pornographic websites",
        ...
        "removalCriteria": [
          ...
          "Content provides methods of contact to acquire pornographic material",
      ...
      },
      {
        ...
        "reference": "Sexually Explicit Language",
        "summary": "Prohibits sexually explicit language that uses explicit or graphic detail about intimate body parts, states of arousal, or intimate encounters",
        ...
        "removalCriteria": [
          ...
          "Content uses explicit or graphic detail about intimate encounters",
          "Content is not shared in humorous or satirical context",
          "Content is not used as cursing"
        ]
      }
    ],
    "appealProcess": null
