...
export const facebookPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2026-01-12T09:11:42.877Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "summary": "Updated terms governing use of Facebook, Messenger and other Meta products, effective January 1, 2025, with significant changes to content rights, AI training permissions, and data usage policies.",
    ...
    "appealProcess": {
      "url": null,
      "summary": "Users can request review of content removal decisions unless violations are serious or repeated, or where legal restrictions apply",
      "steps": [
        "Request another review if content was removed for Community Standards violations",
        "Review is not available for serious or repeated violations",
  ...
  },
  {
    ...
    "summary": "Policy addressing bullying, harassment, and targeted attacks, with significant 2025 changes to hateful conduct provisions that now allow certain forms of harassment against LGBTQ+ individuals and other protected groups.",
  ...
  },
  {
    ...
    "appealProcess": {
      "url": null,
      "summary": "Users can appeal copyright removals by following up with rights owners directly or submitting DMCA counter-notifications when applicable",
      "steps": [
        "Receive notification from Meta with rights owner contact information",
        "Follow up with rights owner directly to resolve the issue",
        "Submit DMCA counter-notification if applicable (instructions provided in removal notification)",
        "Wait for restoration consideration under repeat infringer policy if appeal is successful"
      ]
    }
  },
  {
    ...
    "policies": [
      ...
      },
      {
        ...
        "quote": "Promoting, threatening to share, or offering to make non-real non-consensual intimate imagery (NCII) either by applications, services, or instructions, even if there is no (near) nude commercial or non-commercial imagery shared in the content (sometimes referred to as \"nudify\" apps).",
        "contentTypes": [
          "intimate",
          "other"
        ],
      ...
      },
      {
        ...
        "reference": "Adult Sexual Exploitation Policy",
        "summary": "Prohibits secretly taking non-commercial imagery of a person's intimate body parts or of sexual activity, including photos or videos that mock, sexualize or expose the person",
        "quote": "Sharing secretly taken non-commercial imagery focusing on a person's commonly sexualized body parts (such as breasts, groin, buttocks, or thighs), a person in a sexually suggestive pose, or of a person engaged in sexual activity, and is shared with an intent to mock, sexualize or reveal the identity of the person depicted in the imagery. This imagery is commonly known as \"creepshots\" or \"upskirts\".",
        "contentTypes": [
          "intimate",
          "personal"
        ],
  ...
  },
  {
    ...
    "policies": [
        ...
        "evidenceRequirements": [
          {
            ...
            "example": "Copyright ownership documentation or authorization to act on behalf of rights holder",
      ...
      },
      {
        ...
        "reference": "Third-Party Intellectual Property Infringement",
        "summary": "Removes accounts that engage in repeated violations of intellectual property policy",
  ...
  },
  {
    ...
    "summary": "Comprehensive privacy policy covering data collection, use, sharing, and user rights across Meta platforms, with significant December 2025 updates allowing AI chat interactions to be used for ad personalization and content recommendations.",
  ...
  {
    "id": "facebook-new-1768209102877-0",
    "reference": "META-HATEFUL-CONDUCT-2025",
    "title": "Hateful Conduct Policy",
    "summary": "Policy governing hate speech and discriminatory content, with significant 2025 revisions that now permit certain forms of harassment against LGBTQ+ individuals and other protected groups.",
    "url": "https://transparency.meta.com/policies/community-standards/hateful-conduct/",
    "accessTimestamp": "2026-01-12T09:11:42.877Z",
    "policies": [
      {
        "id": "meta-hateful-conduct-tier1-dehumanizing",
        "reference": "Tier 1 - Dehumanizing speech",
        "summary": "Prohibits dehumanizing speech targeting individuals based on protected characteristics including comparisons to animals, pathogens, or sub-human life forms",
        "quote": "Content targeting a person or group of people (except groups described as having carried out violent or sexual crimes or representing less than half of a group) on the basis of their aforementioned protected characteristic(s) or immigration status in written or visual form with: Dehumanizing speech in the form of comparisons to or generalizations about animals, pathogens, or other sub-human life forms, including: Insects (including but not limited to: cockroaches, locusts), Animals in general or specific types of animals that are culturally perceived as inferior (including but not limited to: Black people and apes or ape-like creatures; Jewish people and rats; Muslim people and pigs; Mexican people and worms), Bacteria, viruses, or microbes, Subhumanity (including but not limited to: savages, devils, monsters)",
        "contentTypes": [
          "personal",
          "other"
        ],
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Content targets a person or group based on protected characteristics",
          "Content contains dehumanizing comparisons to animals, pathogens, or sub-human life forms",
          "Content is in written or visual form"
        ]
      },
      {
        "id": "meta-hateful-conduct-tier1-slurs",
        "reference": "Tier 1 - Slurs",
        "summary": "Prohibits content that describes or negatively targets people with slurs based on protected characteristics",
        "quote": "Content that describes or negatively targets people with slurs. Slurs are defined as words that inherently create an atmosphere of exclusion and intimidation against people on the basis of a protected characteristic, often because these words are tied to historical discrimination, oppression, and violence.",
        "contentTypes": [
          "personal",
          "other"
        ],
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Content describes or negatively targets people with slurs",
          "Slurs are based on protected characteristics",
          "Words create atmosphere of exclusion and intimidation"
        ]
      },
      {
        "id": "meta-hateful-conduct-tier1-mocking-hate-crimes",
        "reference": "Tier 1 - Mocking hate crimes",
        "summary": "Prohibits mocking the concept, events or victims of hate crimes even if no real person is depicted",
        "quote": "Mocking the concept, events or victims of hate crimes even if no real person is depicted in an image.",
        "contentTypes": [
          "personal",
          "other"
        ],
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Content mocks hate crime concepts, events, or victims",
          "Applies even when no real person is depicted in images"
        ]
      },
      {
        "id": "meta-hateful-conduct-tier2-cursing",
        "reference": "Tier 2 - Targeted cursing",
        "summary": "Prohibits targeted cursing against individuals based on protected characteristics with specific exceptions for romantic contexts",
        "quote": "Targeted cursing, except certain gender-based cursing in a romantic break-up context, defined as: Targeted use of \"fuck\" or variations of \"fuck\" with intent to insult, such as \"Fuck the [Protected Characteristic]!\", Terms or phrases calling for engagement in sexual activity, or contact with genitalia, anus, feces or urine, including but not limited to: suck my dick, kiss my ass, eat shit.",
        "contentTypes": [
          "personal",
          "other"
        ],
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Content contains targeted cursing based on protected characteristics",
          "Cursing has intent to insult",
          "Content calls for engagement in sexual activity or contact with body parts/waste"
        ]
      },
      {
        "id": "meta-hateful-conduct-tier2-insults",
        "reference": "Tier 2 - Insults",
        "summary": "Prohibits insults targeting individuals based on protected characteristics including character attacks and mental characteristics",
        "quote": "Content targeting a person or group of people on the basis of their protected characteristic(s) (in written or visual form) with: Insults, including those about: Character, including but not limited to allegations of cowardice, dishonesty, basic criminality, and sexual promiscuity or other sexual immorality. Mental characteristics, including but not limited to allegations of stupidity, intellectual capacity, and mental illness, and unsupported comparisons between PC groups on the basis of inherent intellectual capacity. We do allow allegations of mental illness or abnormality when based on gender or sexual orientation, given political and religious discourse about transgenderism and homosexuality and common non-serious usage of words like \"weird.\" Other areas, including but not limited to allegations of worthlessness, uselessness, ugliness, dirtiness.",
        "contentTypes": [
          "personal",
          "other"
        ],
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Content targets person or group based on protected characteristics",
          "Content contains character insults including allegations of dishonesty or criminality",
          "Content contains mental characteristic insults including allegations of stupidity",
          "Content contains other insults about worthlessness, ugliness, or dirtiness"
        ]
      }
    ],
    "appealProcess": {
      "url": "https://www.facebook.com/help/contact/319149701968527",
      "summary": "European Union users can submit legal removal requests for content that violates hate speech laws in their country",
      "steps": [
        "Determine if you are a European Union user",
        "Verify content violates hate speech laws in your country",
        "Submit legal removal request through Facebook or Instagram contact forms"
      ]
    }
  }
],
