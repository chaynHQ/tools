...
export const facebookPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2026-02-23T09:22:59.077Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "appealProcess": {
      ...
      "steps": [
        ...
        "Review will not be available for serious or repeated violations",
        "Review may be restricted due to legal liability, community harm, technical limitations, or legal prohibitions"
      ]
    }
  },
  {
    ...
    "appealProcess": {
      ...
      "steps": [
        "Visit the Help Center for guidance on adult nudity and sexual activity policy violations",
  ...
  },
  {
    ...
    "summary": "Comprehensive privacy policy covering data collection, use, sharing, and user rights across Meta platforms, with updates effective December 16, 2025 regarding AI interactions.",
