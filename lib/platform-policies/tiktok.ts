...
export const tiktokPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2025-09-24T14:04:48.646Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "policies": [
      ...
      },
      {
        ...
        "summary": "Provides counter-notice process for removed content with potential restoration after ten business days",
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Content subject to counter-notice may be restored unless court order is filed"
        ]
      }
    ],
    "appealProcess": {
      "url": "https://www.tiktok.com/legal/report/feedback",
      "summary": "Users can contact TikTok through their feedback system for complaints about content uploaded by other users or to request content removal",
      "steps": [
        ...
        "TikTok will review the complaint and take appropriate action"
      ]
    }
  },
  {
  ...
  },
  {
    ...
    "summary": "Comprehensive policy covering copyright infringement, DMCA takedown procedures, trademark violations, and repeat infringer policies. Released March 27, 2025, effective April 26, 2025. Includes specific processes for reporting and appealing IP violations with enhanced counter-notification procedures.",
