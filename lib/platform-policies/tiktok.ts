...
export const tiktokPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2025-12-15T09:11:18.602Z",
    "policies": [
      {
  ...
  },
  {
      ...
      },
      {
        ...
        "timeframes": {
          "response": {
            "value": 10,
            "unit": "days",
            "description": "Content may be restored in ten business days or more after counter-notice"
          },
          "removal": null
        },
        "evidenceRequirements": [],
    ...
    "appealProcess": {
      ...
      "summary": "Users can file complaints about content uploaded by other users and submit counter-notices for copyright claims",
      "steps": [
        "Contact TikTok at the provided feedback URL",
        "For counter-notices, submit through TikTok's Copyright Agent",
