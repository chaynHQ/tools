...
export const tiktokPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2026-04-20T09:40:03.693Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "summary": "Legal agreement between TikTok USDS Joint Venture LLC and users establishing platform rules, user obligations, and enforcement mechanisms. Updated January 2026 following TikTok's transition to US ownership, with new provisions for data collection and AI content policies.",
    ...
    "policies": [
      {
        ...
        "quote": "you must not use, or help anyone else use, the Platform to: do anything misleading or harmful",
        "contentTypes": [
          "intimate",
          "personal",
          "other"
      ...
      {
        "id": "tt-tos-exploitative-minor-engagement",
        "reference": "Section 3.4",
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Content that engages with minors in an exploitative or inappropriate way"
        ]
      },
      {
        "id": "tt-tos-consent-violation",
        "reference": "Section 3.4",
        "summary": "Prohibits uploading content that violates laws requiring consent of individuals whose images appear",
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Content uploaded without consent of individuals whose images appear",
          "Content that violates laws requiring consent of legally authorized representatives"
        ]
      },
      {
        "id": "tt-tos-impersonation-spam",
        "reference": "Section 3.4",
      ...
      },
      {
        ...
        "summary": "Reserves right to remove or restrict access to any content for violations or potential harm",
      ...
      },
      {
        ...
        "summary": "Prohibits using AI features to create content that violates rights or deceives others",
      ...
      {
        "id": "tt-tos-ai-deception-prohibition",
        "reference": "Section 3.10",
        "summary": "Prohibits using AI output in a fraudulent manner or to deceive, mislead or impersonate others",
        ...
        "removalCriteria": [
          ...
          "AI-generated content used to deceive or mislead",
          "AI-generated content used to impersonate others"
        ]
      },
      {
        "id": "tt-tos-ai-authenticity-disclosure",
        "reference": "Section 3.10",
        "summary": "Prohibits representing AI-generated output as human-generated or removing AI disclosure markers",
        ...
        "removalCriteria": [
          ...
          "Removal or alteration of AI disclosure watermarks or metadata",
          "Content that creates false impression of human generation"
        ]
      }
    ],
    "appealProcess": {
      ...
      "steps": [
        ...
        "Users will receive notification of the review outcome"
      ]
    }
  },
  {
    ...
    "summary": "Policy governing collection, use, and protection of user personal information by TikTok USDS Joint Venture LLC. Updated February 2026 with enhanced location tracking capabilities, AI interaction data collection, and expanded advertising data usage following US ownership transition.",
  ...
  },
  {
    ...
    "summary": "Comprehensive policy covering copyright infringement, DMCA takedown procedures, trademark violations, and repeat infringer policies. Updated April 2025 with enhanced enforcement mechanisms, clearer fair use guidelines, and strengthened repeat infringer policies including immediate account suspension for severe violations.",
