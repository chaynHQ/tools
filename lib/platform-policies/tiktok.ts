  ...
  policyDocuments: [
    {
      ...
      summary:
        'Comprehensive community guidelines covering prohibited content and behavior on TikTok.',
      ...
      policies: [
        {
          ...
          quote:
            'We strictly prohibit adult nudity, sexual exploitation, and the sharing of non-consensual intimate imagery (NCII), including deepfakes.',
        ...
        },
        {
          ...
          reference: 'TT-CG-AI',
          summary:
            'Prohibits using AI to create non-consensual intimate imagery and requires labeling for other realistic AI content.',
          quote:
            'We prohibit using AI to create non-consensual intimate imagery. Requires labeling for other realistic AI content.',
          contentTypes: ['intimate'],
        ...
        },
        {
          ...
          quote:
            'We prohibit bullying, harassment, and abusive behavior, including posting content to mock, humiliate, or harass someone.',
        ...
        },
        {
          ...
          quote:
            'We prohibit sharing personally identifiable information (PII) without consent, a practice known as doxing.',
          contentTypes: ['intimate', 'personal', 'private'],
          contentContexts: ['hacked', 'impersonation', 'relationship', 'unknown', 'other'],
          timeframes: null,
          evidenceRequirements: [
        ...
        },
        {
          ...
          summary:
            'Prohibits impersonating individuals or organizations in a deceptive manner. Parody or fan accounts must be clearly stated.',
          quote:
            'We prohibit impersonating individuals or organizations in a deceptive manner. Parody or fan accounts must be clearly stated in the account name or bio.',
          contentTypes: ['intimate', 'personal', 'private'],
      ...
      appealProcess: {
        summary:
          'Users can appeal content decisions through in-app notifications and account status pages.',
        steps: [
      ...
      policies: [
        {
          ...
          reference: 'TT-TOS-IP',
          summary:
            'Prohibits copyright infringement, including unauthorized posting of intimate images owned by the victim or photographer.',
          quote:
            'We prohibit copyright infringement. If the intimate image was created and owned by the victim or a photographer, its unauthorized posting is a copyright violation.',
        ...
        },
        {
          ...
          evidenceRequirements: [
            ...
            {
              description:
                'Contact TikTok support directly through the feedback form with details of the compromise if recovery fails',
