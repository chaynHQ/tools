...
export const tiktokPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2025-11-24T09:08:05.497Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "appealProcess": {
      ...
      "summary": "Users can file complaints about content uploaded by other users and request removal of their own content through TikTok's feedback system",
      "steps": [
        "Contact TikTok through the feedback system at https://www.tiktok.com/legal/report/feedback",
        "Provide description of the content and information to locate it",
        "For California residents under 18, label requests as 'California Removal Request' in email subject line"
      ]
    }
  },
  {
    ...
    "summary": "Policy governing collection, use, and protection of user personal information, including provisions for data sharing with law enforcement and content moderation processes. Last updated November 2025 with enhanced privacy controls and transparency features.",
  ...
  },
  {
    ...
    "summary": "Comprehensive policy covering copyright infringement, DMCA takedown procedures, trademark violations, and repeat infringer policies. Includes specific processes for reporting and appealing IP violations. Updated 2025 with enhanced AI-generated content provisions and stricter enforcement mechanisms.",
  ...
  },
  {
    ...
    "summary": "Specific community guidelines section addressing privacy violations, personal information sharing, and security threats. Released August 14, 2025, effective September 13, 2025, with enhanced definitions of high-risk and moderate-risk personal information sharing and improved reporting mechanisms.",
    ...
    "policies": [
      ...
      },
      {
        ...
        "reference": "Platform Security",
        "summary": "Prohibits attempting to reverse-engineer platform code, systems, or algorithms or creating versions based on them",
        ...
        "removalCriteria": [
          ...
          "Creating versions based on platform code or systems"
        ]
      }
    ],
    "appealProcess": {
