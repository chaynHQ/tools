...
export const tiktokPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2025-09-23T20:33:31.819Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "summary": "Comprehensive policy document outlining TikTok's content standards, including prohibitions on non-consensual intimate imagery, harassment, bullying, and sexually explicit content. Updated September 13, 2025 with enhanced policies for AI content, live streaming, and commercial disclosure.",
  ...
  },
  {
    ...
    "policies": [
      ...
      },
      {
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Content subject to counter-notice process may be restored unless court action is filed"
        ]
      }
    ],
    "appealProcess": {
      "url": "https://www.tiktok.com/legal/report/feedback",
      "summary": "Users can contact TikTok through their feedback system to file complaints about content or request account deletion. Counter-notices can be filed for copyright-related removals with potential content restoration after ten business days unless legal action is taken.",
      "steps": [
        ...
        "Content may be restored in ten business days or more unless court action is filed"
      ]
    }
  },
  {
    ...
    "summary": "Policy governing collection, use, and protection of user personal information, including provisions for data sharing with law enforcement and content moderation processes. US-specific version for users 13 and over.",
    ...
    "appealProcess": {
      ...
      "summary": "Users can appeal decisions by following instructions in communications received from TikTok regarding their requests",
      "steps": [
  ...
  },
  {
    ...
    "summary": "Comprehensive policy covering copyright infringement, DMCA takedown procedures, trademark violations, and repeat infringer policies. Includes specific processes for reporting and appealing IP violations. Updated March 27, 2025, effective April 26, 2025.",
    ...
    "appealProcess": {
      ...
      "steps": [
        ...
        "Appeal is forwarded to original reporter including contact information",
  ...
  },
  {
    ...
    "summary": "Detailed policies on harassment, bullying, hate speech, and violent content. Includes specific provisions for protecting minors and public figures, with enhanced enforcement mechanisms. Updated September 13, 2025.",
  ...
  },
  {
    ...
    "summary": "Policy governing sexually suggestive content, adult themes, and age-restricted material. Includes content levels system and restrictions for teen accounts. Updated September 13, 2025.",
    ...
    "policies": [
      ...
      },
      {
        ...
        "summary": "Prohibits or age-restricts adults using sexually explicit language or showing sex products in certain regions",
  ...
  {
    "id": "tiktok-new-1758659611819-0",
    "reference": "TIKTOK-PRIVACY-SEC-2025",
    "title": "TikTok Privacy and Security Guidelines",
    "summary": "Specific community guidelines section addressing privacy violations, personal information sharing, and security threats. Covers high-risk and moderate-risk personal information categories with enforcement mechanisms.",
    ...
    "policies": [
      ...
      },
      {
        ...
        "summary": "Prohibits moderate risk personal information shared without consent if it puts someone at risk of psychological harm",
      ...
      {
        "id": "tt-ps-high-risk-info-types",
        "reference": "Personal Information - High Risk Types",
        "summary": "Prohibits sharing of high risk personal information including home addresses, account login information, sensitive payment information, and identity numbers",
      ...
      {
        "id": "tt-ps-moderate-risk-info-types",
        "reference": "Personal Information - Moderate Risk Types",
        "summary": "Prohibits sharing of moderate risk personal information including contact details, medical information, image/audio likeness, and private communications on sensitive subjects",
      ...
      },
      {
        ...
        "removalCriteria": [
          ...
          "Account hacking activities",
          "Use of phishing, smishing, or automated tools to access data"
        ]
      }
    ],
    "appealProcess": {
