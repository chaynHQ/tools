...
export const tiktokPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "summary": "US federal law signed into law on May 19, 2025, that criminalizes the nonconsensual publication of intimate images, including AI-generated deepfakes, and requires covered platforms to implement notice-and-removal processes within one year. The law creates criminal penalties and establishes civil remedies for victims of non-consensual intimate imagery.",
    "url": "https://www.congress.gov/bill/119th-congress/senate-bill/146/text",
    "accessTimestamp": "2026-02-02T09:18:10.076Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "summary": "Legal agreement between TikTok and users establishing platform rules, user obligations, and enforcement mechanisms. Recently updated in 2026 following TikTok's transition to US ownership, with new terms and privacy policies that users must accept to continue using the platform.",
    ...
    "policies": [
      ...
      },
      {
        ...
        "reference": "Section 3.4",
        "summary": "Prohibits using or attempting to use another's account without authorization",
      ...
      },
      {
        ...
        "summary": "Reserves right to ban or suspend accounts for violations of Terms or Community Guidelines",
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Violation of Terms, Community Guidelines, or other conditions or policies",
          "Legal requirements",
  ...
  },
  {
    ...
    "summary": "Policy governing collection, use, and protection of user personal information. Updated in January 2026 following TikTok's US ownership transition, with significant changes including expanded location tracking capabilities, broader sensitive data collection (including immigration status), and new data processing frameworks under US law.",
  ...
  },
  {
    ...
    "summary": "Comprehensive policy covering copyright infringement, DMCA takedown procedures, trademark violations, and repeat infringer policies. Released March 27, 2025, effective April 26, 2025, with enhanced enforcement mechanisms including immediate account bans for severe violations and stricter fair use guidelines.",
    ...
    "appealProcess": {
      ...
      "steps": [
        ...
        "Platform makes final decision on content reinstatement"
      ]
    }
  },
  {
  ...
  },
  {
    ...
    "policies": [
      ...
      },
      {
        ...
        "reference": "Platform Security",
        "summary": "Prohibits attempts to reverse-engineer platform code, systems, or algorithms or create unauthorized versions",
