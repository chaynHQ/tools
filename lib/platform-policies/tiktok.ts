...
export const tiktokPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "summary": "US federal law signed May 19, 2025, that criminalizes the nonconsensual publication of intimate images, including AI-generated deepfakes, and requires covered platforms to implement notice-and-removal processes for such content by May 19, 2026.",
    "url": "https://www.congress.gov/bill/119th-congress/senate-bill/146/text",
    "accessTimestamp": "2026-01-19T09:11:53.414Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "summary": "Comprehensive policy document outlining TikTok's content standards, including prohibitions on non-consensual intimate imagery, harassment, bullying, and sexually explicit content. Updated with enhanced policies for AI content and live streaming.",
  ...
  },
  {
    ...
    "appealProcess": {
      ...
      "steps": [
        "Contact TikTok through the feedback system to file complaints about content",
  ...
  },
  {
    ...
    "summary": "Policy governing collection, use, and protection of user personal information, including provisions for data sharing with law enforcement and content moderation processes. Last updated August 19, 2024.",
    ...
    "appealProcess": {
      ...
      "summary": "Users may appeal decisions by following instructions in communications received from TikTok",
      "steps": [
        "Submit initial request through privacy report form",
  ...
  },
  {
    ...
    "appealProcess": {
      ...
      "summary": "Users can submit appeals through in-app notifications for both copyright and trademark infringement reports, with different processes for EU and non-EU users",
      "steps": [
        ...
        "TikTok may forward appeal to original reporter where appropriate",
  ...
  },
  {
    ...
    "summary": "Detailed policies on harassment, bullying, hate speech, and violent content. Includes specific provisions for protecting minors and public figures, with enhanced enforcement mechanisms for sexual harassment and coordinated abuse.",
  ...
  },
  {
    ...
    "summary": "Policy governing sexually suggestive content, adult themes, and age-restricted material. Includes content levels system and audience controls for creators to restrict content to viewers 18 and older.",
  ...
  },
  {
    ...
    "summary": "Specific community guidelines section addressing privacy violations, personal information sharing, and security threats. Includes policies on high-risk and moderate-risk personal information sharing, with updated August 14, 2025.",
    ...
    "appealProcess": {
      ...
      "steps": [
        "Report privacy violations through the provided link"
      ]
    }
  }
],
