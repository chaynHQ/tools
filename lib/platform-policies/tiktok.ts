...
export const tiktokPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2025-11-03T09:09:23.795Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "appealProcess": {
      ...
      "steps": [
        ...
        "Unless the original complaining party files a court action, removed content may be replaced or access restored in ten business days or more after receipt of the counter-notice"
      ]
    }
  },
  {
    ...
    "appealProcess": {
      ...
      "steps": [
        ...
        "Follow the instructions in the communication to appeal the decision"
      ]
    }
  },
  {
    ...
    "appealProcess": {
      ...
      "summary": "Users can appeal copyright and trademark removals through in-app notifications, with different processes for EU and non-EU users including counter-notification procedures",
      "steps": [
        ...
        "For copyright appeals, TikTok may forward your appeal to the original reporter",
        "Content may be reinstated if it doesn't infringe rights or no court action is filed"
      ]
    }
  },
  {
