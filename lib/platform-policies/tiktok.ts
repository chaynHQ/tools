  ...
  policyDocuments: [
    {
      ...
      summary:
        'Comprehensive community guidelines covering prohibited content and behavior on TikTok, including harassment, bullying, NCII, impersonation, and content removal policies. Updated September 13, 2025 with enhanced policies on AI content, LIVE creators, and commercial content disclosure.',
      url: 'https://www.tiktok.com/community-guidelines/en/',
      accessTimestamp: '2025-09-18T16:28:25.100Z',
      policies: [
        {
          id: 'tt-ncii-policy',
        ...
        },
        {
          ...
          reference: 'TT-CG-AI',
          summary:
            'Requires clear labeling when AI or editing is used to realistically depict people or scenes and prohibits AIGC that misleads or harms individuals.',
          quote:
        ...
        },
        {
          ...
          summary:
            'Prohibits content that harasses or bullies others, including degrading remarks about appearance, doxing, sexual harassment, or coordinated abuse.',
          quote:
            "We don't allow content that harasses or bullies others, including degrading remarks about appearance, doxing, sexual harassment, or coordinated abuse.",
          contentTypes: ['intimate', 'personal', 'private'],
        ...
        },
        {
          ...
          summary:
            'Prohibits sharing personal information that could lead to harm, such as identity theft, stalking, or fraud.',
          quote:
        ...
        },
        {
          ...
          summary:
            'Prohibits accounts that mislead or try to manipulate the platform through deceptive behavior.',
          quote:
        ...
        },
        {
          ...
          reference: 'TT-CG-IP',
          summary:
            'Prohibits content that violates intellectual property rights, including reposts of copyrighted or trademarked material without permission.',
          quote:
    ...
    },
    {
      ...
      summary:
        'Legal terms governing the use of TikTok, including content ownership and intellectual property rights.',
      ...
      policies: [
        {
          ...
          reference: 'TT-TOS-IP',
          summary:
            'Prohibits copyright infringement with reference to separate Copyright Policy for detailed procedures.',
          quote:
        ...
        },
        {
          ...
          summary:
            'Prohibits uploading private information of third parties, defamatory content, and material designed to harass or embarrass people.',
          quote:
        ...
        },
        {
          ...
          reference: 'TT-TOS-USE',
          summary:
            'Prohibits impersonating any person or entity or falsely representing affiliation, including giving impression content emanates from TikTok services.',
          quote:
        ...
        },
        {
          ...
          summary:
            'Requires users to keep account passwords confidential and immediately notify TikTok if account is compromised.',
          quote:
        ...
        },
        {
          ...
          summary:
            'TikTok reserves right to remove or disable access to content for any reason, including content that violates Terms or Community Guidelines.',
          quote:
        ...
        },
        {
          ...
          reference: 'TT-TOS-CONTENT',
          summary:
            'Provides process for filing complaints about content uploaded by other users through feedback system.',
          quote:
        ...
        },
        {
          ...
          reference: 'TT-TOS-CONTENT',
          summary:
            'TikTok reserves right to disclose user identity to third parties claiming intellectual property or privacy rights violations.',
          quote:
        ...
        },
        {
          ...
          reference: 'TT-TOS-CA',
          summary:
            'California residents under 18 may request removal of their posted content through specific process.',
          quote:
      ...
      appealProcess: {
        ...
        summary:
          'General feedback system for disputes and complaints, with specific counter-notice process for copyright claims',
        steps: [
          ...
          'Unless original complainant files court action, removed content may be restored in ten business days or more after counter-notice receipt',
        ],
      },
    },
    {
      ...
      summary:
        'Privacy policy explaining how TikTok collects, uses, and protects user data. Last updated August 19, 2024 with enhanced data protection measures and user rights.',
      ...
      policies: [
        {
          ...
          summary:
            'California residents under 18 can request removal of User Content they posted, and Connecticut residents under 18 (or their parents/guardians if under 16) can request account deletion.',
          quote:
        ...
        },
        {
          ...
          summary:
            'Users can submit requests to know, access, correct or delete information collected about them, including through an authorized agent.',
          quote:
        ...
        },
        {
          ...
          summary:
            "Parents or guardians can request deletion of their underage child's account or download account data.",
          quote:
            'As a parent or guardian, you can also request the deletion of the account of your underage child or download the account data of your underage child by contacting us at https://www.tiktok.com/legal/report/privacy.',
          contentTypes: ['personal', 'private', 'other'],
          contentContexts: ['other'],
          timeframes: null,
          evidenceRequirements: [
            {
        ...
        },
        {
          ...
          reference: 'TT-PP-CHILDREN-TEENS',
          summary:
            'TikTok will delete accounts and personal information if they become aware a user is under 13 years old.',
          quote:
            "If we become aware that personal information has been collected on the Platform from a Child, we will delete this information and terminate the Child's account. If you believe there is a user who is below the age of 13, please contact us at: https://www.tiktok.com/legal/report/feedback.",
          contentTypes: ['personal', 'private', 'other'],
          contentContexts: ['other'],
          timeframes: null,
          evidenceRequirements: [
      ...
      appealProcess: {
        ...
        summary:
          'Users can appeal decisions made about their privacy requests by following instructions in the communication received from TikTok.',
        steps: [
          'Submit initial request through privacy portal',
          'Receive communication from TikTok about decision',
    ...
    },
    {
      ...
      summary:
        'Comprehensive policy covering copyright infringement, DMCA takedown procedures, trademark violations, and repeat infringer policies.',
      ...
      policies: [
        {
          ...
          summary:
            'TikTok removes content that infringes copyright and may ban accounts for repeated violations.',
          quote:
            "We do not allow any content that infringes copyright. The use of copyrighted content of others without proper authorization or legally valid reason may lead to a violation of TikTok's policies. Any user content that infringes another person's copyright may be removed.",
          contentTypes: ['other'],
          contentContexts: ['other'],
          timeframes: null,
          evidenceRequirements: [
            {
              description:
                'Complete copyright infringement report form with all requested information',
        ...
        },
        {
          ...
          summary:
            'TikTok removes content that violates trademark rights and prohibits counterfeit goods promotion.',
          quote:
            "Any content that violates another's trademark rights may be taken down and we do not permit the purchase, sale, trade, promotion, or solicitation of counterfeit goods on TikTok, and will remove such content.",
          contentTypes: ['other'],
          ...
          evidenceRequirements: [
            {
              description:
                'Complete trademark infringement report form with all requested information',
        ...
        },
        {
          ...
          summary:
            'TikTok bans accounts of users who repeatedly commit intellectual property infringement and may immediately ban accounts for severe violations.',
          quote:
      ...
      appealProcess: {
        url: null,
        summary:
          'Users can appeal content removal through in-app notifications, with different processes for EU and non-EU users. Appeals require complete information and may be forwarded to original reporters.',
        steps: [
    ...
    },
    {
      ...
      summary:
        'Detailed policies on harassment, bullying, hate speech, and violent behavior with specific enforcement mechanisms.',
      ...
      policies: [
        {
          ...
          summary:
            'TikTok prohibits image-based sexual abuse, including sharing intimate images without consent, and removes such content while supporting survivors.',
          quote:
        ...
        },
        {
          ...
          reference: 'TT-SAFETY-CIVILITY-5',
          summary:
            'TikTok prohibits sextortion, defined as threatening to share nude or sexual content without permission to demand money, sex, or more explicit content.',
          quote:
        ...
        },
        {
          ...
          summary:
            'TikTok prohibits sexual harassment including sexualization or sexual degradation of individuals through language or behaviors relating to sexual activities and intimate body parts.',
          quote:
          ...
          evidenceRequirements: [
            {
              ...
              example:
                'Screenshots of sexual comments about intimate body parts or sexual performance',
        ...
        },
        {
          ...
          reference: 'TT-SAFETY-CIVILITY-7',
          summary:
            'TikTok prohibits doxing, which includes publishing or threatening to publish personal information about someone online with malicious intent.',
          quote:
          ...
          evidenceRequirements: [
            {
              ...
              example:
                'Screenshots showing private information with threatening captions or hashtags',
        ...
        },
        {
          ...
          reference: 'TT-SAFETY-CIVILITY-7',
          summary:
            'TikTok prohibits inciting harassment or promoting coordinated abuse, including encouraging others to leave abusive comments or falsely report accounts.',
          quote:
          ...
          evidenceRequirements: [
            {
              ...
              example:
                'Posts encouraging others to target, comment on, or report specific accounts',
        ...
        },
        {
          ...
          reference: 'TT-SAFETY-CIVILITY-7',
          summary:
            "TikTok prohibits insulting someone's physical attributes including weight, facial features, or body parts as a form of harassment.",
          quote:
          ...
          evidenceRequirements: [
            {
              ...
              example:
                'Posts or comments making derogatory remarks about appearance, weight, or body parts',
              reason:
                'To establish the degrading nature of the content targeting physical attributes',
            },
          ],
          removalCriteria: [
      ...
      appealProcess: {
        url: null,
        summary:
          'The document references a Notice and Appeals section but does not provide specific appeal process details in the current content.',
        steps: [
          "Report violations through TikTok's in-app reporting system",
          'For intimate privacy violations, use the dedicated reporting form at tiktok.com/legal/report/privacy',
    ...
    },
    {
      ...
      summary:
        'Specific policies on personal information sharing, stalking prevention, identity theft protection, and platform security.',
      ...
      policies: [
        {
          ...
          summary:
            'TikTok prohibits content containing high-risk personal information that could lead to stalking, identity theft, fraud, or other harm, including when posted by the person themselves or with their consent.',
          quote:
            "we don't allow content with personal information that could lead to stalking, identity theft, fraud, or other harm. This includes content that someone has posted themselves or that they consented to being shared by others.",
          contentTypes: ['personal', 'private', 'other'],
          contentContexts: ['hacked', 'impersonation', 'relationship', 'unknown', 'other'],
          timeframes: null,
          evidenceRequirements: [
        ...
        },
        {
          ...
          reference: 'TT-PRIVACY-SECURITY-1',
          summary:
            'TikTok may remove moderate-risk personal information shared without consent if it puts someone at risk of psychological harm, requiring additional context for removal decisions.',
          quote:
          ...
          evidenceRequirements: [
            {
              ...
              example:
                'Evidence showing how the shared information causes emotional distress or reputational damage',
        ...
        },
        {
          ...
          reference: 'TT-PRIVACY-SECURITY-1',
          summary:
            'TikTok considers image/audio likeness as moderate-risk personal information that may be removed when shared without consent and likely to cause psychological harm.',
          quote:
            "Moderate Risk Personal Information: Information that isn't inherently risky, but may still cause harm—like emotional distress, reputational damage, or unwanted contact—especially when combined with other data. Examples include: Contact details or date of birth, Medical information, Image/audio likeness, Private communications on sensitive subjects, disclosed by individuals who were not part of the exchange",
          contentTypes: ['personal', 'intimate', 'private', 'other'],
          contentContexts: ['hacked', 'impersonation', 'relationship', 'unknown', 'other'],
          timeframes: null,
          evidenceRequirements: [
            {
              ...
              example:
                "Documentation showing lack of permission to use the person's image or audio",
              reason: 'Consent is required for sharing image/audio likeness',
            },
            {
              description: 'Context showing potential for psychological harm',
              example:
                'Information demonstrating emotional distress, reputational damage, or unwanted contact',
        ...
        },
        {
          ...
          summary:
            'TikTok prohibits unauthorized access to accounts and using compromised accounts to break platform rules.',
          quote:
          ...
          evidenceRequirements: [
            {
              ...
              example:
                'Documentation showing account was compromised or accessed without permission',
        ...
        },
        {
          ...
          reference: 'TT-PRIVACY-SECURITY-2',
          summary:
            'TikTok prohibits attempts to steal personal information, hack accounts, or access data through deceptive methods like phishing and automated tools.',
          quote:
    ...
    },
    {
      ...
      summary:
        'Policies covering impersonation, deceptive account behavior, misinformation, and platform manipulation.',
      ...
      policies: [
        {
          ...
          summary:
            'TikTok prohibits using the likeness of private figures without consent in AI-generated or significantly edited content.',
        ...
        },
        {
          ...
          summary:
            'TikTok removes AI-generated or edited content that creates sexualized, fetishized, or victimizing depictions of individuals.',
          ...
          evidenceRequirements: [
            {
              description:
                'Identification of the sexualized, fetishized, or victimizing nature of the content',
              example:
                'Description of how the AI-generated content sexualizes or victimizes the depicted person',
        ...
        },
        {
          ...
          evidenceRequirements: [
            {
              description:
                'Evidence that AI-generated content is being used for bullying or harassment',
              example: 'Screenshots showing the harassing context or repeated targeting',
              reason:
                'To demonstrate the bullying or harassing intent behind the AI-generated likeness',
            },
          ],
          removalCriteria: [
        ...
        },
        {
          ...
          summary:
            'TikTok removes accounts that impersonate others by pretending to be someone else without clearly stating the account is fan or parody content.',
          quote:
          ...
          evidenceRequirements: [
            {
              ...
              reason:
                'To verify you are the person being impersonated and establish the impersonation',
            },
          ],
          removalCriteria: [
        ...
        },
        {
          ...
          summary:
            "TikTok removes content that violates someone else's intellectual property rights including copyrights and trademarks.",
          ...
          evidenceRequirements: [
            {
              ...
              example:
                'Copyright registration, trademark registration, or other documentation of IP ownership',
        ...
        },
        {
          ...
          summary:
            'TikTok prohibits distribution of hacked materials when this poses a significant risk of harm.',
      ...
      appealProcess: {
        url: null,
        summary:
          'TikTok mentions enforcement actions may be appealed, but specific appeal process details are referenced in other sections not included in this document.',
        steps: [
          "Submit appeal through TikTok's system (specific process not detailed in this document)",
          'TikTok reviews the appeal against community guidelines',
          'Decision communicated to user',
        ],
      },
    },
    {
      ...
      summary:
        'Detailed policies on adult nudity, sexual content, sexually suggestive content, and age-restricted material.',
      ...
      policies: [
        {
          ...
          summary:
            'TikTok prohibits nudity, sexual activity, and sexually suggestive content involving youth, with limited exceptions for educational or artistic content.',
          quote:
            "we don't allow certain types of body exposure or sexualized behavior, including: Nudity or sexual activity, Sexual Services, Sexually suggestive acts or significant body exposure involving youth",
          ...
          evidenceRequirements: [
            {
              description:
                'Report content that violates body exposure and sexualized behavior policies',
              example:
                'Content showing nudity, sexual activity, or sexually suggestive acts involving minors',
        ...
        },
        {
          ...
          summary:
            'TikTok age-restricts and removes from For You feed content showing significant adult body exposure or sexually suggestive behavior involving adults.',
          quote:
          ...
          evidenceRequirements: [
            {
              description:
                'Report content showing significant adult body exposure or sexually suggestive behavior',
              example:
                "Content showing adults wearing only nipple covers or underwear that doesn't cover most of the buttocks",
        ...
        },
        {
          ...
          summary:
            'TikTok prohibits extremely gory, disturbing, or violent content that could cause psychological harm, with some exceptions for public interest content that may be age-restricted.',
          quote:
            "we don't allow anything extremely gory, disturbing, or violent, especially when it could cause psychological harm",
          contentTypes: ['other'],
          contentContexts: ['unknown', 'other'],
          timeframes: null,
          evidenceRequirements: [
        ...
        },
        {
          ...
          summary:
            'TikTok prohibits animal abuse, cruelty, neglect, and exploitation in all forms.',
          quote:
            "We don't allow animal abuse, cruelty, neglect, or any other form of animal exploitation",
          contentTypes: ['other'],
          contentContexts: ['unknown', 'other'],
          timeframes: null,
          evidenceRequirements: [
            {
              ...
              example:
                'Content showing inhumane slaughter, mutilation, abuse, or mistreatment of animals',
