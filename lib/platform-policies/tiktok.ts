...
export const tiktokPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2026-03-23T09:24:11.277Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "summary": "Legal agreement between TikTok and users establishing platform rules, user obligations, and enforcement mechanisms. Incorporates Community Guidelines by reference and establishes TikTok's authority to remove violating content. Updated January 2026 following US ownership transition.",
    ...
    "appealProcess": {
      ...
      "summary": "Users can submit appeals through functionalities provided on the Platform for account bans, suspensions, or restricted access to features",
      "steps": [
  ...
  },
  {
    ...
    "summary": "Policy governing collection, use, and protection of user personal information, including provisions for data sharing with law enforcement and content moderation processes. Updated January 2026 with expanded location data collection and enhanced data processing disclosures.",
    ...
    "appealProcess": {
      ...
      "summary": "Users can appeal decisions made about their privacy requests through the same contact methods used for initial requests",
      "steps": [
        "Submit appeal through the privacy webform at https://www.tiktok.com/legal/report/privacy",
        "Alternatively, send appeal to physical address: TikTok USDS Joint Venture LLC, Attn: Privacy Policy Inquiry, 5800 Bristol Parkway, Suite 300, Culver City, CA 90230"
      ]
    }
  },
  {
    ...
    "appealProcess": {
      ...
      "steps": [
        ...
        "Platform may contact user for additional information",
  ...
  },
  {
    ...
    "summary": "Specific community guidelines section addressing privacy violations, personal information sharing, and security threats. Includes policies on high-risk and moderate-risk personal information sharing. Updated September 13, 2025.",
    ...
    "policies": [
      ...
      },
      {
        ...
        "reference": "Platform Security",
        "summary": "Prohibits attempting to reverse-engineer platform code, systems, or algorithms or creating unauthorized versions",
