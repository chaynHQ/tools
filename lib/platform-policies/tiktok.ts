...
export const tiktokPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2025-09-18T18:39:47.315Z",
    "policies": [
      {
        "id": "tt-ncii-policy",
  ...
  },
  {
    ...
    "policies": [
      ...
      },
      {
        ...
        "summary": "Provides counter-notice process for content removal with potential restoration after 10 business days.",
        ...
        "evidenceRequirements": [
          {
            "description": "Counter-notice filed with TikTok's Copyright Agent",
        ...
        "removalCriteria": [
          "Original complaining party does not file court action within 10 business days",
          "Counter-notice is properly filed and not made in bad faith"
        ]
      }
    ],
    "appealProcess": {
      "url": "https://www.tiktok.com/legal/report/feedback",
      "summary": "Users can file complaints about content through TikTok's feedback system and utilize counter-notice process for copyright claims.",
      "steps": [
        "Submit complaint through TikTok feedback system at https://www.tiktok.com/legal/report/feedback",
  ...
  },
  {
    ...
    "appealProcess": {
      ...
      "steps": [
        ...
        "Follow instructions in the communication to appeal the decision"
      ]
    }
  },
  {
  ...
  },
  {
    ...
    "summary": "Policies covering impersonation, deceptive account behavior, misinformation, and platform manipulation. Updated August 14, 2025 with enhanced AI content policies and effective September 13, 2025.",
