...
export const tiktokPolicy: PlatformPolicies = {
  ...
  },
  {
    ...
    "appealProcess": {
      ...
      "summary": "General feedback system for disputes and complaints, with specific counter-notice process for copyright claims",
      "steps": [
  ...
  },
  {
    ...
    "appealProcess": {
      "url": null,
      "summary": "The document references a Notice and Appeals section but does not provide specific appeal process details in the current content.",
      "steps": [
  ...
  },
  {
    ...
    "appealProcess": {
      "url": null,
      "summary": "TikTok mentions enforcement actions may be appealed, but specific appeal process details are referenced in other sections not included in this document.",
      "steps": [
