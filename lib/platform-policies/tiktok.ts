...
export const tiktokPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "summary": "US federal law that criminalizes the nonconsensual publication of intimate images, including AI-generated deepfakes, and requires covered platforms to implement notice-and-removal processes for such content. Signed into law May 19, 2025, with platforms having until May 19, 2026 to implement required notice-and-removal processes.",
    "url": "https://www.congress.gov/bill/119th-congress/senate-bill/146/text",
    "accessTimestamp": "2026-06-15T11:09:32.363Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "summary": "Legal agreement between TikTok and users establishing platform rules, user obligations, and enforcement mechanisms. Major update January 22, 2026 reflecting US ownership transition to TikTok USDS Joint Venture LLC, with expanded data collection provisions and new corporate structure.",
    ...
    "policies": [
      ...
      {
        "id": "tt-tos-inauthentic-commercial-behaviors",
        "reference": "Section 3.4",
        "summary": "Prohibits inauthentic commercial behaviors including spam and impersonation accounts",
        ...
        "removalCriteria": [
          ...
          "Other inauthentic commercial behaviors"
        ]
      },
      {
        "id": "tt-tos-content-removal-discretion",
        "reference": "Section 3.6",
        "summary": "Reserves right to remove or restrict access to content that violates Terms, Community Guidelines, or may cause harm",
      ...
      {
        "id": "tt-tos-intellectual-property-rights",
        "reference": "Section 3.9",
        "summary": "Requires respect for copyright and other intellectual property rights with reporting mechanisms for infringement",
        ...
        "removalCriteria": [
          ...
          "Content that infringes other intellectual property rights"
        ]
      },
      {
        "id": "tt-tos-generative-ai-restrictions",
        "reference": "Section 3.10",
        "summary": "Prohibits using AI features to create content that violates Terms, infringes rights, or deceives others",
        "quote": "you agree not to: Provide, create, or otherwise use Input or Output in a way that violates these Terms, our Community Guidelines, or other conditions or policies or any applicable laws, or that infringes, violates or misappropriates the rights of TikTok USDS Joint Venture, our users, or any third party",
        "contentTypes": [
          "intimate",
          "personal",
          "other"
      ...
      {
        "id": "tt-tos-account-suspension-rights",
        "reference": "Section 5.2",
        "summary": "Reserves right to ban, suspend accounts or restrict access for Terms violations or security issues",
        ...
        "timeframes": {
          ...
          "removal": {
            "value": null,
            "unit": "immediate",
            "description": "Account suspension or restriction may occur at any time without prior notice"
          }
        },
        "evidenceRequirements": [],
        "removalCriteria": [
          "Violation of Terms, Community Guidelines, or other policies",
          "Legal requirements",
    ...
    "appealProcess": {
      ...
      "summary": "Users can submit appeals through Platform functionalities for account bans, suspensions, or access restrictions",
      "steps": [
  ...
  },
  {
    ...
    "summary": "Policy governing collection, use, and protection of user personal information operated by TikTok USDS Joint Venture LLC. Major update February 5, 2026 following US ownership transition, with expanded location data collection, AI content analysis provisions, and new data sovereignty arrangements.",
    ...
    "appealProcess": {
      ...
      "summary": "Users can appeal decisions made about their requests through the same contact methods used for initial requests",
      "steps": [
        "Submit appeal through the privacy webform at https://www.tiktok.com/legal/report/privacy",
        "Alternatively, send appeal to the physical mailing address: TikTok USDS Joint Venture LLC, Attn: Privacy Policy Inquiry, 5800 Bristol Parkway, Suite 300, Culver City, CA 90230"
      ]
    }
  },
  {
    ...
    "summary": "Comprehensive policy covering copyright infringement, DMCA takedown procedures, trademark violations, and repeat infringer policies. Updated March 27, 2025, effective April 26, 2025 with significantly stricter enforcement mechanisms, immediate account suspension for repeat violations, and enhanced reporting processes.",
    ...
    "appealProcess": {
      ...
      "steps": [
        ...
        "Content may be reinstated at platform's discretion based on review"
      ]
    }
  },
  {
    ...
    "summary": "Detailed policies on harassment, bullying, hate speech, and violent content. Updated August 14, 2025, effective September 13, 2025 with enhanced protections for minors and public figures, expanded definitions of harmful content, and improved enforcement mechanisms for doxing and sexual harassment.",
  ...
  },
  {
    ...
    "summary": "Policy governing sexually suggestive content, adult themes, and age-restricted material. Updated August 14, 2025, effective September 13, 2025 with enhanced content levels system, stricter restrictions for teen accounts, and clearer guidelines on nudity, sexual activity, and body exposure.",
  ...
  },
  {
    ...
    "summary": "Specific community guidelines section addressing privacy violations, personal information sharing, and security threats. Updated August 14, 2025, effective September 13, 2025 with enhanced policies on high-risk and moderate-risk personal information sharing, expanded definitions of harmful information disclosure, and stronger protections against stalking and identity theft.",
