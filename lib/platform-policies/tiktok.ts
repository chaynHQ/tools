...
export const tiktokPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2026-05-25T10:36:36.588Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "summary": "Comprehensive policy document outlining TikTok's content standards, including prohibitions on non-consensual intimate imagery, harassment, bullying, and sexually explicit content. Updated August 2025 with enhanced policies for AI content, live streaming, and content moderation approaches.",
  ...
  },
  {
    ...
    "summary": "Legal agreement between TikTok USDS Joint Venture and users establishing platform rules, user obligations, and enforcement mechanisms. Updated January 2026 to reflect new US ownership structure and enhanced data collection policies including precise location tracking.",
    ...
    "policies": [
      ...
      },
      {
        ...
        "summary": "Requires respect for copyright and other intellectual property rights of others",
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Content that infringes copyright of others",
          "Content that violates intellectual property rights"
        ]
      }
    ],
    "appealProcess": {
      ...
      "summary": "Users can submit appeals through platform functionalities when accounts are banned, suspended, or access is restricted",
      "steps": [
  ...
  },
  {
    ...
    "summary": "Policy governing collection, use, and protection of user personal information under TikTok USDS Joint Venture. Updated January 2026 with new provisions for precise location tracking, AI interactions, and expanded advertising network capabilities.",
    ...
    "appealProcess": {
      ...
      "steps": [
        "Submit appeal through the privacy request webform",
        "Provide details about the original request and reason for appeal",
        "TikTok will review the appeal and respond according to applicable law"
      ]
    }
  },
  {
    ...
    "appealProcess": {
      ...
      "summary": "Users can appeal content removal through in-app notifications with different processes for EU and non-EU users, including counter-notification procedures and potential content reinstatement",
      "steps": [
        ...
        "Content may be reinstated if it does not infringe rights or no court action is filed"
      ]
    }
  },
  {
