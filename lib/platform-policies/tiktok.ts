...
export const tiktokPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2025-11-17T09:08:18.277Z",
    "policies": [
      {
    ...
    "policies": [
      ...
      },
      {
        ...
        "removalCriteria": [
          ...
          "No court order filed by original complaining party within specified timeframe"
        ]
      }
    ],
    "appealProcess": {
