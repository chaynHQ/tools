...
export const tiktokPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "summary": "US federal law that criminalizes the nonconsensual publication of intimate images, including AI-generated deepfakes, and requires covered platforms to implement notice-and-removal processes for such content. Signed into law May 19, 2025.",
    "url": "https://www.congress.gov/bill/119th-congress/senate-bill/146/text",
    "accessTimestamp": "2026-03-09T09:18:39.323Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "summary": "Legal agreement between TikTok USDS Joint Venture LLC and US users establishing platform rules, user obligations, and enforcement mechanisms. Updated January 22, 2026 to reflect new US ownership structure and enhanced data collection policies.",
    ...
    "appealProcess": {
      ...
      "summary": "Users can submit appeals through functionalities provided on the Platform if they believe their account was wrongly banned, suspended, or restricted",
      "steps": [
        "Submit an appeal through the functionalities provided on the Platform",
        "TikTok will review the decision",
        "Users will be notified of the outcome of the review"
      ]
    }
  },
  {
    ...
    "summary": "Policy governing collection, use, and protection of user personal information under new US ownership. Updated January 22, 2026 with expanded location tracking, AI content processing, and advertising data usage provisions.",
  ...
  },
  {
    ...
    "summary": "Comprehensive policy covering copyright infringement, DMCA takedown procedures, trademark violations, and repeat infringer policies. Updated March 27, 2025 (effective April 26, 2025) with enhanced enforcement mechanisms and clearer violation consequences.",
  ...
  },
  {
    ...
    "summary": "Detailed policies on harassment, bullying, hate speech, and violent content. Updated August 14, 2025 (effective September 13, 2025) with refined definitions and enhanced protections for vulnerable groups.",
