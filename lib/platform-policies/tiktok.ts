...
export const tiktokPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "summary": "US federal law, now Public Law No. 119-12, that criminalizes the nonconsensual publication of intimate images, including AI-generated deepfakes, and requires covered platforms to implement notice-and-removal processes for such content within one year of enactment (by May 19, 2026).",
    "url": "https://www.congress.gov/bill/119th-congress/senate-bill/146/text",
    "accessTimestamp": "2026-07-04T14:09:38.942Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "summary": "Comprehensive policy document outlining TikTok's content standards, including prohibitions on non-consensual intimate imagery, harassment, bullying, and sexually explicit content. Guidelines apply globally and are organized by topic with 'Not Allowed', 'Age-Restricted', and 'FYF Ineligible' content tiers; updated September 13, 2025.",
    "url": "https://www.tiktok.com/community-guidelines/en/overview",
    "accessTimestamp": "2026-07-04T14:09:38.942Z",
    "policies": [
      {
      ...
      {
        "id": "tt-cg-aigc-labeling",
        "reference": "Integrity and Authenticity - Edited Media and AI-Generated Content (AIGC)",
        "summary": "Requires clear labeling when AI or editing is used to realistically depict people or scenes",
        "quote": "We require clear labeling when AI or editing is used to realistically depict people or scenes.",
        "contentTypes": [
          "intimate",
          "personal",
          "other"
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "AI-generated or edited content realistically depicting people or scenes that is not clearly labeled"
        ]
      },
      {
        "id": "tt-cg-violent-criminal-behavior",
        "reference": "Safety and Civility - Violent and Criminal Behavior",
        "summary": "Prohibits threats, encouragement or glorification of violence, promotion of crime, or instructions on how to commit harmful acts",
        "quote": "We don't allow threats, encouragement or glorification of violence, promotion of crime, or instructions on how to commit harmful acts.",
        "contentTypes": [
          "other"
        ],
        "contentContexts": [
        ...
        "removalCriteria": [
          ...
          "Promotion of crime",
          "Instructions on how to commit harmful acts"
        ]
      },
      {
        "id": "tt-cg-frauds-scams",
        "reference": "Regulated Goods, Services, and Commercial Activities - Frauds and Scams",
        "summary": "Prohibits content that promotes or facilitates scams, fraud, or deceptive schemes, including sextortion-related deception",
        "quote": "We don't allow content that promotes or facilitates scams, fraud, or deceptive schemes.",
        "contentTypes": [
          "private",
          "personal",
          "other"
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Content that promotes scams",
          "Content that facilitates fraud",
          "Content that facilitates deceptive schemes"
        ]
      }
    ],
    "appealProcess": null
  },
  {
    ...
    "summary": "Legal agreement between users and TikTok USDS Joint Venture LLC (the new US operator following TikTok's ownership transition) establishing platform rules, user obligations, and enforcement mechanisms. Incorporates Community Guidelines and Privacy Policy by reference, references the Intellectual Property Policy, and establishes TikTok's authority to remove violating content and process counter-notices. Updated January 22, 2026.",
    ...
    "policies": [
      ...
      {
        "id": "tt-tos-uploading-without-consent",
        "reference": "Section 3.4",
        "summary": "Prohibits uploading content depicting individuals without their consent or the consent of their legally authorized representatives, where required by law",
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Content uploaded in violation of applicable laws requiring consent of individuals depicted",
          "Content posted without the consent of the person depicted or their legally authorized representative"
        ]
      },
      {
        "id": "tt-tos-inauthentic-impersonation-accounts",
        "reference": "Section 3.4",
        "summary": "Prohibits inauthentic commercial behavior including operating spam or impersonation accounts",
      ...
      {
        "id": "tt-tos-unauthorized-account-use-2025",
        "reference": "Section 3.4",
      ...
      {
        "id": "tt-tos-ai-fraudulent-impersonation",
        "reference": "Section 3.10",
        "summary": "Prohibits using generative AI features to create or use content in a fraudulent manner or to deceive, mislead, or impersonate others",
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "AI-generated Input or Output used in a fraudulent manner",
          "AI-generated Input or Output used to deceive, mislead, or impersonate others"
        ]
      },
      {
        "id": "tt-tos-ai-content-violation",
        "reference": "Section 3.10",
        "summary": "Prohibits creating or using AI-generated Input or Output that violates Terms, Community Guidelines, or infringes the rights of others",
        ...
        "removalCriteria": [
          ...
          "AI-generated content that infringes or violates the rights of TikTok, users, or third parties"
        ]
      },
      {
        "id": "tt-tos-ai-watermark-misrepresentation",
        "reference": "Section 3.10",
        "summary": "Prohibits misrepresenting AI-generated Output as human-generated, including by removing or altering watermarks or disclosures",
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "AI-generated Output misrepresented as human-generated",
          "Removal, obscuring, or alteration of watermarks or content-authenticating metadata"
        ]
      },
      {
        "id": "tt-tos-content-removal-harm-legal",
        "reference": "Section 3.6",
        "summary": "Reserves right to remove or restrict access to any content that violates Terms, causes harm to users or others, or is required to be removed by law",
      ...
      },
      {
        ...
        "summary": "Reserves right to ban or suspend accounts, or restrict access to features, for violations of Terms or Community Guidelines",
        ...
        "timeframes": {
          ...
          "removal": {
            "value": null,
            "unit": "immediate",
            "description": "Accounts may be banned or suspended at any time without prior notice"
          }
        },
        "evidenceRequirements": [],
        "removalCriteria": [
          "Belief that user violated Terms, Community Guidelines, or other conditions or policies",
          "Legal requirement to ban or suspend account",
    ...
    "appealProcess": {
      ...
      "summary": "Users may appeal account bans, suspensions, or restrictions imposed by TikTok through functionalities provided on the Platform.",
      "steps": [
        "Submit an appeal through the functionalities provided on the Platform",
        "TikTok will review the decision to ban, suspend, or restrict account access"
      ]
    }
  },
  {
    ...
    "summary": "Policy governing collection, use, and protection of user personal information by TikTok USDS Joint Venture LLC, including provisions for data sharing with law enforcement, content moderation processes, and enforcement of Terms of Service and Community Guidelines. Updated January 22, 2026 amid TikTok's transition to US ownership, with expanded location and AI-interaction data provisions.",
    ...
    "policies": [
      ...
      },
      {
        ...
        "summary": "Prohibits collection of personal information from children outside the designated children's experience and requires deletion of such data and account termination when discovered",
        ...
        "timeframes": {
          ...
          "removal": {
            "value": null,
            "unit": "immediate",
            "description": "Deletion of information and account termination upon discovery"
          }
        },
        "evidenceRequirements": [],
        "removalCriteria": [
      ...
      },
      {
        ...
        "quote": "Users of the Services who are California residents and are under 18 years of age may request and obtain removal of user content they posted by contacting us at: https://www.tiktok.com/legal/report/privacy.",
        "contentTypes": [
          "intimate",
          "personal",
          "private",
      ...
      {
        "id": "tiktok-pp-legal-reasons-disclosure-protection",
        "reference": "How We Share Your Information - For Legal Reasons",
        "summary": "Allows disclosure and enforcement actions to protect user safety, security, and rights, including in response to legal claims",
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Necessary to enforce applicable terms",
          "Necessary to protect safety, security, rights, or interests of users, affiliates, or the public"
        ]
      }
    ],
    "appealProcess": {
      "url": "https://www.tiktok.com/legal/report/privacy",
      "summary": "Users can submit requests regarding their information, including content removal requests, and may appeal any decision made about their request through the same channels.",
      "steps": [
        "Submit a request via the webform or mailing address provided in the Contact Us section",
        "Provide information necessary to verify identity or account ownership",
        "Await response from TikTok regarding the request",
        "Appeal any decision made about the request through the same submission methods"
      ]
    }
  },
  {
    ...
    "policies": [
      ...
      },
      {
        ...
        "summary": "Removes user content that infringes copyright, may restrict access to the LIVE feature, and may ban accounts of repeat infringers or in cases of severe violations",
        ...
        "removalCriteria": [
          ...
          "User infringes copyright while using the LIVE feature",
      ...
      },
      {
        ...
        "reference": "Removal of Content; Account Bans",
        "summary": "Removes content that violates trademark rights, prohibits counterfeit goods, may restrict access to the LIVE feature, and may ban accounts of repeat infringers or in cases of severe violations",
        ...
        "removalCriteria": [
          ...
          "Trademark violation occurs in connection with the LIVE feature",
    ...
    "appealProcess": {
      ...
      "summary": "Users whose content is removed due to a copyright or trademark infringement report are notified in-app and may submit an appeal through the app, providing contact information and supporting evidence. Appeals may be forwarded to the original reporter, who may pursue legal action to keep the content down. Content may be reinstated at TikTok's discretion if it does not infringe rights or no legal action is taken.",
      "steps": [
        ...
        "Submit an appeal within the TikTok app via the in-app notification, providing contact information and any evidence supporting the claim.",
        "TikTok may contact the user with additional questions; incomplete information may result in denial of the appeal.",
        "Where appropriate and legally authorised, TikTok forwards the appeal (including contact information) to the original reporter.",
        "For non-EU users under DMCA-equivalent processes, content may be reinstated if the rightsholder does not file a court action to keep it down, or if the content is determined not to infringe.",
        "Decision to reinstate content is at TikTok's sole discretion."
      ]
    }
  },
  {
    ...
    "summary": "Detailed policies on harassment, bullying, hate speech, and violent content, as well as image-based sexual abuse, sextortion, and non-consensual sexual acts. Includes specific provisions for protecting minors and public figures, with enhanced enforcement mechanisms. Confirmed current as of the September 2025 Community Guidelines update.",
    ...
    "policies": [
      ...
      },
      {
        ...
        "removalCriteria": [
          ...
          "Content includes violent threats, hate speech, or sexual exploitation, even when targeting public figures"
        ]
      }
    ],
    "appealProcess": null
  },
  {
    ...
    "summary": "Policy governing sexually suggestive content, adult themes, and age-restricted material. Includes content levels system and restrictions for teen accounts. Confirmed current and accessible.",
    ...
    "policies": [
      {
        ...
        "removalCriteria": [
          ...
          "Limited exceptions exist for documentaries, sex education, fiction, and art"
        ]
      },
      {
        "id": "tt-cg-sexual-services",
        "reference": "Body Exposure and Sexualized Behaviors - NOT ALLOWED",
        "summary": "Prohibits facilitating access to sexual services",
      ...
      },
      {
        ...
        "removalCriteria": [
          ...
          "Content depicts sexually suggestive behavior involving adults"
        ]
      }
    ],
    "appealProcess": null
  },
  {
    ...
    "summary": "Specific community guidelines section addressing privacy violations, personal information sharing, and security threats. Includes policies on high-risk and moderate-risk personal information sharing. Confirmed current and accessible.",
  ...
  {
    "id": "tiktok-new-1783174178942-0",
    "reference": "TIKTOK-NCII-REPORT-2025",
    "title": "TikTok Sexual Exploitation and Abuse Reporting Form",
    "summary": "Dedicated TikTok reporting mechanism (via report-sexual-exploitation-abuse-tiktok-us.zendesk.com) specifically for victims to report Child Sexual Exploitation/Abuse, Nonconsensual Intimate Imagery, and Explicit Deepfake content, separate from general content-violation reporting.",
    "url": "https://report-sexual-exploitation-abuse-tiktok-us.zendesk.com/hc/en-us/requests/new",
    "accessTimestamp": "2026-07-04T14:09:38.942Z",
    "policies": [
      {
        "id": "tiktok-ncii-csea-prohibition",
        "reference": null,
        "summary": "Prohibits content, whether real or AI-generated, that contains any form of sexual exploitation or abuse, including child sexual abuse material, nonconsensual intimate imagery, and explicit deepfakes.",
        "quote": "We do not allow content, real or AI-generated, containing any form of sexual exploitation or abuse.",
        "contentTypes": [
          "intimate",
          "other"
        ],
        ...
        "timeframes": null,
        "removalCriteria": [
          "Content contains child sexual exploitation or abuse material",
          "Content contains nonconsensual intimate imagery",
          "Content contains explicit deepfakes"
        ]
      },
      {
        "id": "tiktok-csea-definition",
        "reference": null,
        "summary": "Prohibits child sexual abuse material, including obscene content that depicts a child engaging in or simulating sexual conduct.",
        "quote": "Child Sexual Exploitation / Abuse (i.e., child pornography as defined by 18 U.S.C § 2256 or other obscene matter that depicts you or your child engaging in or simulating sexual conduct)",
        "contentTypes": [
          "intimate",
          "other"
        ],
        ...
        "timeframes": null,
        "removalCriteria": [
          "Content depicts a child engaging in or simulating sexual conduct",
          "Content meets the legal definition of child sexual abuse material"
        ]
      },
      {
        "id": "tiktok-ncii-definition",
        "reference": null,
        "summary": "Prohibits real or AI-generated intimate imagery depicting a person in sexual acts or nudity that was created or posted without their consent.",
        "quote": "Nonconsensual Intimate Imagery (i.e., a visual depiction of real or computer/AI generated images of you (or someone you have authorization to represent) engaged in sexual acts or nudity that was created or posted without consent)",
        "contentTypes": [
          "intimate"
        ],
        "contentContexts": [
        ...
        "timeframes": null,
        "removalCriteria": [
          "Content depicts sexual acts or nudity",
          "Content was created without the depicted person's consent",
          "Content was posted without the depicted person's consent"
        ]
      },
      {
        "id": "tiktok-explicit-deepfake-definition",
        "reference": null,
        "summary": "Prohibits computer or AI-generated or altered depictions of a person engaging in sexual conduct or nudity that did not occur in reality, regardless of any claimed consent.",
        "quote": "Explicit Deepfake (i.e., a computer or AI generated or altered visual depiction of a person engaging in sexual conduct or nudity that did not occur in reality, regardless of whether the individual is believed to have provided consent for the creation and/or posting of the imagery)",
        "contentTypes": [
          "intimate",
          "other"
        ],
        ...
        "timeframes": null,
        "removalCriteria": [
          "Content is a computer or AI-generated or altered depiction of sexual conduct or nudity",
          "Depicted conduct did not occur in reality",
          "Applies regardless of whether consent for creation or posting was given"
        ]
      },
      {
        "id": "tiktok-law-enforcement-reporting",
        "reference": null,
        "summary": "Reports incidents of child sexual abuse and exploitation to the National Center for Missing and Exploited Children as legally required, and to law enforcement when there is a specific, credible, and imminent threat to life or serious physical injury.",
        "quote": "We report incidents of child sexual abuse and exploitation to the National Center for Missing and Exploited Children (NCMEC), as required by law. We also report to relevant law enforcement authorities when there is a specific, credible, and imminent threat to human life or serious physical injury.",
        "contentTypes": [
          "intimate",
          "other"
        ],
        ...
        "timeframes": null,
        "removalCriteria": [
          "Content constitutes child sexual abuse or exploitation material",
          "There is a specific, credible, and imminent threat to human life or serious physical injury"
        ]
      },
      {
        "id": "tiktok-ncii-removal-and-identical-copy-search",
        "reference": null,
        "summary": "Removes content that violates Community Guidelines, including non-consensual intimate imagery or other sexual abuse material, and makes reasonable efforts to find and remove identical copies where technically feasible and legally required.",
        "quote": "If the content you report violates our Community Guidelines (including because it depicts non-consensual intimate imagery or other sexual abuse material), it will be removed and, where technically feasible and as required by law, we will make reasonable efforts to search for and remove identical copies of any non-consensual intimate imagery or child sexual abuse material.",
        "contentTypes": [
          "intimate",
          "other"
        ],
        ...
        "removalCriteria": [
          "Content violates Community Guidelines",
          "Content depicts non-consensual intimate imagery",
          "Content constitutes other sexual abuse material",
          "Identical copies of the reported content exist on the platform"
        ]
      }
    ],
    "appealProcess": null
