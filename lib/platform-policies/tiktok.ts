...
export const tiktokPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2026-03-30T09:35:01.541Z",
    "policies": [
      {
    ...
    "policies": [
      {
        ...
        "removalCriteria": [
          ...
          "Sexual harassment",
          "Coordinated abuse",
          "Content that crosses into severe harm"
        ]
      },
      {
  ...
  },
  {
    ...
    "summary": "Legal agreement between TikTok USDS Joint Venture LLC and users establishing platform rules, user obligations, and enforcement mechanisms. Updated January 2026 following TikTok's transition to US-based ownership, incorporating Community Guidelines by reference and establishing TikTok's authority to remove violating content.",
    ...
    "policies": [
      ...
      },
      {
        ...
        "reference": "Section 3.4",
        "summary": "Prohibits uploading content in violation of applicable laws including laws requiring consent of individuals whose images appear in content",
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Content uploaded in violation of applicable laws",
          "Content containing images of individuals without their consent"
        ]
      },
      {
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Operating spam or impersonation accounts",
      ...
      {
        "id": "tt-tos-commercial-content-use",
        "reference": "Section 3.4",
        "summary": "Prohibits using TikTok Content, another user's content or generative AI-enabled features for commercial purposes unless permitted",
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Using TikTok Content for commercial purposes without permission",
          "Using another user's content for commercial purposes without permission",
          "Using generative AI-enabled features for commercial purposes without permission"
        ]
      },
      {
        "id": "tt-tos-content-removal-discretion",
        "reference": "Section 3.6",
        "summary": "Reserves right to remove or restrict access to any content for violations, harm to users, or legal requirements",
        ...
        "timeframes": {
          ...
          "removal": {
            "value": null,
            "unit": "immediate",
            "description": "Content may be removed at any time for violations or legal requirements"
          }
        },
        "evidenceRequirements": [],
        "removalCriteria": [
          ...
          "Content that violates the rights of users or third parties",
          "Content removal required by legal requirement or court order"
        ]
      },
      {
        "id": "tt-tos-ai-content-violations",
        "reference": "Section 3.10",
        "summary": "Prohibits using generative AI features to create content that violates Terms, Community Guidelines, or infringes rights",
      ...
      },
      {
        ...
        "reference": "Section 3.10",
        "summary": "Prohibits representing AI-generated content as human-generated or using it to deceive or impersonate others",
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "AI-generated content represented as human-generated",
          "Removal or alteration of AI content watermarks or metadata"
        ]
      },
      {
        "id": "tt-tos-ai-fraudulent-use",
        "reference": "Section 3.10",
        "summary": "Prohibits using AI-generated content in a fraudulent manner or to deceive, mislead or impersonate others",
  ...
  },
  {
    ...
    "summary": "Policy governing collection, use, and protection of user personal information by TikTok USDS Joint Venture LLC, including provisions for data sharing with law enforcement and content moderation processes. Updated February 2026 following ownership transition, with expanded location tracking capabilities and revised data handling practices.",
  ...
  },
  {
    ...
    "appealProcess": {
      ...
      "steps": [
        ...
        "Platform may contact user for additional information if needed",
        "Appeal may be forwarded to original reporter including contact information",
        "Platform makes final decision on content reinstatement at their sole discretion"
      ]
    }
  },
  {
  ...
  },
  {
    ...
    "policies": [
      ...
      },
      {
        ...
        "reference": "Platform Security",
        "summary": "Prohibits reverse-engineering platform code, systems, or algorithms, or creating unauthorized versions based on them",
    ...
    "appealProcess": {
      ...
      "steps": [
        "Access the privacy reporting form at the provided URL",
