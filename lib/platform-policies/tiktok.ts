  ...
  policyDocuments: [
    {
      ...
      summary:
        'US federal law that criminalizes the nonconsensual publication of intimate images, including AI-generated deepfakes, and requires covered platforms to implement notice-and-removal processes for such content.',
      ...
      policies: [
        {
          ...
          summary:
            'Prohibits knowingly publishing authentic intimate visual depictions of adults without consent when obtained under circumstances with reasonable expectation of privacy, not voluntarily exposed publicly, not a matter of public concern, and intended to cause or causing harm',
          quote:
        ...
        },
        {
          ...
          summary:
            'Prohibits knowingly publishing digital forgeries (deepfakes) of adults without consent when not voluntarily exposed publicly, not a matter of public concern, and intended to cause or causing harm',
          quote:
        ...
        },
        {
          ...
          summary:
            'Requires covered platforms to remove nonconsensual intimate visual depictions within 48 hours of receiving a valid removal request and make reasonable efforts to identify and remove identical copies',
          quote:
          ...
          evidenceRequirements: [
            {
              description:
                'Physical or electronic signature of the individual or authorized person',
              example: 'Digital signature or scanned signature',
              reason: 'To verify identity and authorization for the removal request',
            },
            {
              description:
                'Identification and location information for the intimate visual depiction',
            ...
            },
            {
              ...
              reason:
                'To establish that the content violates the nonconsensual publication prohibition',
            },
            {
        ...
        },
        {
          ...
          summary:
            'Requires covered platforms to establish a notice and removal process for individuals to request removal of nonconsensual intimate visual depictions',
          quote:
          ...
          timeframes: {
            response: {
              ...
              unit: 'years',
              description:
                'Platforms must establish the notice and removal process within 1 year of enactment',
            },
            removal: null,
          },
          evidenceRequirements: [],
    ...
    },
    {
      ...
      summary:
        "Comprehensive policy document outlining TikTok's content standards, including prohibitions on non-consensual intimate imagery, harassment, bullying, and sexually explicit content. Updated September 2025 with enhanced policies for AI content and live streaming.",
      ...
      policies: [
        ...
        },
        {
          ...
          summary:
            'Prohibits content that shows, promotes, or facilitates adult sexual abuse or exploitation',
          quote:
        ...
        },
        {
          ...
          contentTypes: ['private', 'personal', 'other'],
          contentContexts: ['hacked', 'impersonation', 'relationship', 'unknown', 'other'],
          timeframes: null,
          evidenceRequirements: [],
          removalCriteria: [
        ...
        },
        {
          ...
          summary:
            "Prohibits attempts to hack, reverse-engineer, or otherwise compromise TikTok's systems",
          quote:
        ...
        },
        {
          ...
          summary:
            'Prohibits accounts that mislead or try to manipulate the platform, or the trade of services that artificially boost engagement or trick the recommendation system',
          quote:
        ...
        },
        {
          ...
          reference:
            'Integrity and Authenticity - Unoriginal Content and Intellectual Property Rights',
          summary:
        ...
        },
        {
          ...
          summary:
            'Prohibits AI-generated content that misleads about matters of public importance or that harms individuals',
          quote:
            "We don't allow AIGC that misleads about matters of public importance or that harms individuals.",
    ...
    },
    {
      ...
      summary:
        "Legal agreement between TikTok and users establishing platform rules, user obligations, and enforcement mechanisms. Incorporates Community Guidelines by reference and establishes TikTok's authority to remove violating content.",
      ...
      policies: [
        {
          ...
          reference: 'Section 5',
          summary:
            'Prohibits intimidating or harassing others and promoting sexually explicit material',
          quote:
        ...
        },
        {
          ...
          reference: 'Section 5',
          summary:
            'Prohibits impersonating any person or entity or falsely misrepresenting identity or affiliation',
          quote:
        ...
        },
        {
          ...
          reference: 'Section 5',
          summary:
            'Prohibits uploading private information of third parties including personal documents and contact details',
          quote:
        ...
        },
        {
          ...
          reference: 'Section 5',
          summary:
            'Prohibits material that infringes copyright, trademark or other intellectual property rights',
          quote:
        ...
        },
        {
          ...
          reference: 'Section 5',
          summary:
            'Prohibits material designed to provoke, harass, harm, hurt, scare, distress, embarrass or upset people',
          quote:
        ...
        },
        {
          ...
          reference: 'Section 5',
          summary:
            "Prohibits using or attempting to use another's account or system without authorization",
          quote:
        ...
        },
        {
          ...
          reference: 'Section 5',
          summary:
            'Reserves right to remove or disable access to content at discretion for violations or harm to services or users',
          quote:
        ...
        },
        {
          ...
          reference: 'Section 7',
          summary:
            'Reserves right to remove, disallow, block or delete any User Content that violates Terms or in response to complaints',
          quote:
        ...
        },
        {
          ...
          reference: 'Section 7',
          summary:
            'Reserves right to disclose user identity to third parties claiming intellectual property or privacy rights violations',
          quote:
        ...
        },
        {
          ...
          reference: 'Section 7',
          summary:
            'Takes reasonable measures to expeditiously remove infringing material and may disable accounts of repeat infringers',
          quote:
    ...
    },
    {
      ...
      summary:
        'Policy governing collection, use, and protection of user personal information, including provisions for data sharing with law enforcement and content moderation processes. Last updated August 2024.',
      ...
      policies: [
        {
          ...
          summary:
            'Prohibits content that violates Terms of Service and Community Guidelines through scanning and analysis of user content and messages',
          quote:
        ...
        },
        {
          ...
          summary:
            'Prohibits collection of personal information from children and requires immediate account termination and data deletion when discovered',
          quote:
            "If we become aware that personal information has been collected on the Platform from a Child, we will delete this information and terminate the Child's account.",
          contentTypes: ['intimate', 'personal', 'private', 'other'],
          contentContexts: ['hacked', 'impersonation', 'relationship', 'unknown', 'other'],
          timeframes: {
            response: {
        ...
        },
        {
          ...
          reference: 'Content Removal for Users Under 18',
          summary:
            'Allows Connecticut users under 18 and parents of users under 16 to request account deletion or unpublishing',
          quote:
      ...
      appealProcess: {
        ...
        summary:
          'Users may appeal decisions made about their requests by following instructions in the communication received from TikTok',
        steps: [
    ...
    },
    {
      ...
      summary:
        'Comprehensive policy covering copyright infringement, DMCA takedown procedures, trademark violations, and repeat infringer policies. Includes specific processes for reporting and appealing IP violations. Updated March 2025.',
      ...
      policies: [
        {
          ...
          summary:
            'Prohibits any content that infringes copyright, including unauthorized use of copyrighted content without proper authorization',
          quote:
          ...
          contentTypes: ['personal', 'intimate', 'other'],
          contentContexts: ['hacked', 'relationship', 'unknown', 'other'],
          timeframes: null,
          evidenceRequirements: [
            {
              description:
                'All information requested in the online Copyright Infringement Report form',
              example:
                'Copyright ownership details, identification of infringing content, contact information',
        ...
        },
        {
          ...
          summary:
            'Prohibits unauthorized use of trademarks that causes confusion about source, origin, sponsorship or affiliation',
          quote:
          ...
          evidenceRequirements: [
            {
              description:
                'All information requested in the online Trademark Infringement Report form',
              example:
                'Trademark ownership details, identification of infringing content, contact information',
        ...
        },
        {
          ...
          reference: 'Removal of Content; Account Bans',
          summary:
            'Removes content that violates trademark rights and may ban accounts of repeat infringers or in cases of severe violations',
          quote:
      ...
      appealProcess: {
        url: null,
        summary:
          'Users can submit appeals through in-app notifications for both copyright and trademark infringement removals, with different processes for EU and non-EU users',
        steps: [
    ...
    },
    {
      ...
      summary:
        'Detailed policies on harassment, bullying, hate speech, and violent content. Includes specific provisions for protecting minors and public figures, with enhanced enforcement mechanisms.',
      ...
      policies: [
        {
          ...
          summary:
            'Prohibits having, sharing, or creating intimate images of someone without their consent, especially for sexual purposes',
          quote:
        ...
        },
        {
          ...
          summary:
            'Prohibits threatening to share intimate or sexual content without permission to demand money, sexual acts, or more explicit content',
          quote:
        ...
        },
        {
          ...
          summary:
            'Prohibits threatening to share intimate or sexual content of young people without permission to demand money, sexual acts, or more explicit content',
          quote:
            'Sextortion: The act of threatening to share nude or sexual content without permission—usually to demand money, sex, or more explicit content.',
          contentTypes: ['intimate'],
          contentContexts: ['relationship', 'unknown', 'other'],
        ...
        },
        {
          ...
          summary:
            'Prohibits sexual content involving young people, including digital or AI-generated images and content that sexualizes young people',
          quote:
        ...
        },
        {
          ...
          summary:
            'Prohibits unwanted sexual comments, behaviors, and sexualization or sexual degradation of individuals',
          quote:
          ...
          contentTypes: ['intimate', 'personal', 'other'],
          contentContexts: ['relationship', 'unknown', 'impersonation', 'other'],
          timeframes: null,
          evidenceRequirements: [],
          removalCriteria: [
        ...
        },
        {
          ...
          summary:
            'Prohibits publishing or threatening to publish personal information about someone online with malicious intent',
          quote:
        ...
        },
        {
          ...
          summary:
            'Prohibits inciting harassment or promoting coordinated abuse against individuals',
          quote:
        ...
        },
        {
          ...
          summary:
            "Prohibits insulting someone's physical attributes including weight, facial features, or body parts",
          quote:
          ...
          timeframes: null,
          evidenceRequirements: [],
          removalCriteria: ['Insulting comments about weight, facial features, or body parts'],
        },
        {
          ...
          quote:
            'This covers content created by others or the young person themselves, and includes digital or AI-generated images.',
          contentTypes: ['intimate'],
    ...
    },
    {
      ...
      summary:
        'Policy governing sexually suggestive content, adult themes, and age-restricted material. Includes content levels system and restrictions for teen accounts.',
      ...
      policies: [
        {
          ...
          summary:
            'Prohibits nudity, sexual activity, and sexually explicit content including digital or illustrated images',
          quote:
            'Showing: Penetrative sex, non-penetrative sex, or oral sex—including digital or illustrated images, like manga; Physical sexual arousal or stimulation; Fetish or kink behavior, such as BDSM or sexual behavior involving a focus on specific body parts; Nudity of adults or young people—including digital or illustrated images, like manga',
          contentTypes: ['intimate'],
          contentContexts: ['hacked', 'relationship', 'unknown', 'other'],
          timeframes: null,
          evidenceRequirements: [],
        ...
        },
        {
          ...
          reference: 'Body Exposure and Sexualized Behaviors - NOT ALLOWED',
          summary:
            'Prohibits facilitating access to sexual services including offering sexual acts, chats, or imagery',
          quote:
        ...
        },
        {
          ...
          reference: 'Body Exposure and Sexualized Behaviors - NOT ALLOWED',
          summary:
            'Prohibits sexually suggestive acts, significant body exposure, intimate kissing, and sexually explicit language involving young people',
          quote:
            'Significant body exposure of young people, such as wearing only underwear or lingerie; Showing young people engaging in intimate kissing, sexually suggestive acts, or sexualized framing; Sexually explicit language involving or directed at young people',
        ...
        },
        {
          ...
          summary:
            'Age-restricts and removes from For You feed content showing significant adult body exposure or sexually suggestive behavior',
          quote:
            "Showing: Significant adult body exposure, such as wearing only nipple covers or underwear that doesn't cover most of the buttocks; In some regions, moderate adult body exposure—such as the side breast or partial exposure of the buttocks that would be typically covered based on cultural norms; Adults engaging in intimate kissing, sexually suggestive acts, or sexualized framing",
          contentTypes: ['intimate'],
          contentContexts: ['hacked', 'relationship', 'unknown', 'other'],
          timeframes: null,
          evidenceRequirements: [],
        ...
        },
        {
          ...
          summary:
            'Removes from For You feed content showing young people in revealing clothing that outlines intimate body parts',
          quote:
        ...
        },
        {
          ...
          reference:
            'Body Exposure and Sexualized Behaviors - NOT ALLOWED / FYF INELIGIBLE & AGE-RESTRICTED',
          summary:
            'Prohibits or age-restricts adults using sexually explicit language or showing sex products depending on region',
          quote:
    ...
    },
    {
      ...
      summary:
        'Specific community guidelines section addressing privacy violations, personal information sharing, and security threats. Includes policies on high-risk and moderate-risk personal information sharing.',
      ...
      policies: [
        {
          ...
          summary:
            'Prohibits content containing high-risk personal information that could lead to stalking, identity theft, fraud, or other harm',
          quote:
        ...
        },
        {
          ...
          summary:
            'Prohibits moderate risk personal information shared without consent when it puts someone at risk of psychological harm',
          quote:
          ...
          evidenceRequirements: [
            {
              ...
              reason:
                'Platform requires additional context to assess moderate risk personal information removal requests',
            },
          ],
          removalCriteria: [
        ...
        },
        {
          ...
          reference: 'Personal Information - Moderate Risk',
          summary:
            'Prohibits sharing image or audio likeness without consent that may cause harm including emotional distress or reputational damage',
          quote:
          ...
          evidenceRequirements: [
            {
              ...
              reason:
                'Platform requires additional context to remove moderate risk personal information',
            },
          ],
          removalCriteria: [
        ...
        },
        {
          ...
          reference: 'Personal Information - Moderate Risk',
          summary:
            'Prohibits sharing private communications on sensitive subjects disclosed by individuals who were not part of the exchange',
          quote:
            "Moderate Risk Personal Information: Information that isn't inherently risky, but may still cause harm—like emotional distress, reputational damage, or unwanted contact—especially when combined with other data. Examples include: Contact details or date of birth, Medical information, Image/audio likeness, Private communications on sensitive subjects, disclosed by individuals who were not part of the exchange",
          contentTypes: ['private', 'personal'],
          contentContexts: ['hacked', 'relationship', 'unknown', 'other'],
          ...
          evidenceRequirements: [
            {
              description: 'Additional context demonstrating potential harm',
              example:
                'Evidence showing the communications were private and disclosed without authorization',
              reason:
                'Platform requires additional context to remove moderate risk personal information',
            },
          ],
        ...
        },
        {
          ...
          summary:
            'Prohibits giving login information to others or allowing them to break platform rules on user accounts',
          quote:
        ...
        },
        {
          ...
          reference: 'Platform Security',
          summary:
            'Prohibits using unauthorized methods to access the platform or creating fake versions of the platform',
          quote:
        ...
        },
        {
          ...
          reference: 'Platform Security',
          summary:
            'Prohibits attempts to steal personal information, hack accounts, or access data using deceptive methods or automated tools',
          quote:
