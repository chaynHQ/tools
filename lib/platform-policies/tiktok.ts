...
export const tiktokPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2025-09-24T13:53:04.939Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "appealProcess": {
      ...
      "summary": "Users can contact TikTok to file complaints about information or materials uploaded by other users",
      "steps": [
        "Contact TikTok at the provided feedback URL",
        "Provide details about the complaint regarding uploaded materials"
      ]
    }
  },
  {
  ...
  },
  {
    ...
    "summary": "Comprehensive policy covering copyright infringement, DMCA takedown procedures, trademark violations, and repeat infringer policies. Includes specific processes for reporting and appealing IP violations. Updated April 26, 2025.",
    ...
    "appealProcess": {
      ...
      "steps": [
        ...
        "Content may be reinstated if no infringement is found or no court action is filed"
      ]
    }
  },
  {
  ...
  },
  {
    ...
    "policies": [
      ...
      },
      {
        ...
        "reference": "Platform Security",
        "summary": "Prohibits reverse-engineering TikTok's code, systems, or algorithms or creating unauthorized versions",
    ...
    "appealProcess": {
      ...
      "steps": [
        "Report privacy violations through the provided reporting link"
      ]
    }
  }
],
