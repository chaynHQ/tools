...
export const tiktokPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2025-12-22T09:09:18.777Z",
    "policies": [
      {
  ...
  },
  {
    ...
    "summary": "Comprehensive policy document outlining TikTok's content standards, including prohibitions on non-consensual intimate imagery, harassment, bullying, and sexually explicit content. Effective September 13, 2025, with enhanced policies for AI content, live streaming, and clearer enforcement guidelines.",
  ...
  },
  {
    ...
    "appealProcess": {
      ...
      "steps": [
        ...
        "Submit the complaint or request through the feedback system"
      ]
    }
  },
  {
    ...
    "appealProcess": {
      ...
      "summary": "Users may appeal decisions about their privacy requests by following instructions in the communication received from TikTok",
      "steps": [
  ...
  },
  {
    ...
    "summary": "Comprehensive policy covering copyright infringement, DMCA takedown procedures, trademark violations, and repeat infringer policies. Released March 27, 2025, effective April 26, 2025, with enhanced enforcement mechanisms and new online forms for copyright holders.",
