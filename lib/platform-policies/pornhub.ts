...
export const pornhubPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2026-05-25T10:34:16.430Z",
    "policies": [
      {
        "id": "ph-tos-ncii",
    ...
    "appealProcess": {
      ...
      "summary": "Users may lodge complaints against content decisions within 6 months via email or webform",
      "steps": [
        ...
        "Include detailed information and explanation of reasons for complaint",
        "Platform handles complaints in timely, non-discriminatory, diligent manner",
        "Platform may reverse decisions if complaint demonstrates content did not violate policies or decision was unjustified"
      ]
    }
  },
  {
  ...
  {
    "id": "pornhub-new-1779705256430-0",
    "reference": "PH-DMCA-POLICY",
    "title": "Pornhub DMCA and Copyright Policy",
    "summary": "Digital Millennium Copyright Act compliance policy covering copyright infringement reporting, takedown procedures, and content removal processes for copyrighted material.",
    "url": "https://www.pornhub.com/information/dmca",
    "accessTimestamp": "2026-05-25T10:34:16.430Z",
    "policies": [
      {
        "id": "ph-dmca-copyright-infringement",
        "reference": "DMCA Notice Requirements",
        "summary": "Prohibits copyright infringement and provides mechanism for removal of copyrighted material including personal images",
        "quote": "We take claims of copyright infringement seriously. We will respond to notices of alleged copyright infringement that comply with the Digital Millennium Copyright Act (the \"DMCA\") or any other applicable intellectual property legislation or laws. Responses may include removing, blocking, or disabling access to material claimed to be the subject of infringing activity, terminating the user's access to https://www.pornhub.com (\"Pornhub\"), or all of the foregoing.",
        "contentTypes": [
          "intimate",
          "personal",
          "other"
        ...
        "evidenceRequirements": [
          {
            "description": "Identification of the copyrighted work believed to have been infringed",
            "example": "Description or title of your original content",
            "reason": "To establish ownership of the copyrighted material"
          },
          {
            "description": "Identification of the infringing material with specific URL",
            "example": "Direct URL to the specific video containing your content",
            "reason": "To locate and remove the specific infringing content"
          },
          {
            "description": "Contact information including name, postal address, telephone number and email",
            "example": "Full legal name and complete contact details",
            "reason": "To allow platform and uploader to contact the complainant"
          },
          {
            "description": "Good faith belief statement that use is not authorized",
            "example": "Statement that you believe the use is not authorized by copyright owner, agent, or law",
            "reason": "Required legal declaration under DMCA"
          },
          {
            "description": "Statement of accuracy and authorization under penalty of perjury",
            "example": "Declaration that information is accurate and you are authorized to act on behalf of copyright owner",
            "reason": "Legal requirement to prevent false claims"
          },
          {
            "description": "Physical or electronic signature",
            "example": "Full legal name typed as signature",
            "reason": "To authenticate the complaint"
          }
        ],
        "removalCriteria": [
          "Material is claimed to be the subject of infringing activity",
          "Notice complies with DMCA requirements",
          "Submitted by copyright owner or authorized agent"
        ]
      },
      {
        "id": "ph-dmca-repeat-infringers",
        "reference": "Repeat Infringers",
        "summary": "Terminates accounts of users who repeatedly infringe intellectual property rights",
        "quote": "In accordance with the DMCA and other applicable law, we have adopted a policy of terminating or disabling, in appropriate circumstances and at our sole discretion, the accounts of users who are deemed to be repeat infringers. We may also at our sole discretion limit access to Pornhub, terminate or disable the accounts of any users who infringe any intellectual property rights of others, whether or not there is any repeat infringement.",
        "contentTypes": [
          "intimate",
          "personal",
          "other"
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "User is deemed to be a repeat infringer",
          "User infringes intellectual property rights of others",
          "Platform determines termination is appropriate in its sole discretion"
        ]
      },
      {
        "id": "ph-dmca-automated-blocking",
        "reference": "Video Fingerprinting",
        "summary": "Uses automated system to identify and block potentially infringing content from being uploaded",
        "quote": "We use MediaWise®, an automated audiovisual identification system, to assist us in identifying and blocking potentially infringing content from being uploaded by users. Videos uploaded to Pornhub are compared against a database of digital fingerprints. When a video is matched to a digital fingerprint, access to it is disabled.",
        "contentTypes": [
          "intimate",
          "personal",
          "other"
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Video matches a digital fingerprint in the database",
          "Content is identified as potentially infringing by automated system"
        ]
      }
    ],
    "appealProcess": {
      "url": "mailto:copyright@aylofreesites.com",
      "summary": "Counter-notification process for users who believe their content was removed by mistake or misidentification",
      "steps": [
        "Submit counter-notice to designated copyright agent at copyright@aylofreesites.com",
        "Include name, address, phone number and signature in counter-notice",
        "Identify the removed content and its previous location",
        "Provide statement under penalty of perjury that content was removed by mistake",
        "Consent to jurisdiction of U.S. Federal District Court",
        "Platform forwards counter-notice to original complainant",
        "Content may be restored after 10-14 business days unless court action is filed"
      ]
    }
  }
],
