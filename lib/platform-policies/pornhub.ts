...
export const pornhubPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2025-09-23T21:06:37.460Z",
    "policies": [
      {
        "id": "ph-tos-ncii",
    ...
    "appealProcess": {
      ...
      "summary": "Users may lodge complaints against content decisions within 6 months via email or webform, with review handled in a timely, non-discriminatory manner",
      "steps": [
        ...
        "Platform reviews complaint in timely, objective manner",
  ...
  },
  {
    ...
    "summary": "US federal law signed into law on May 19, 2025, prohibiting nonconsensual intimate visual depictions including deepfakes, requiring covered platforms to implement 48-hour notice-and-removal processes by May 19, 2026.",
