...
export const pornhubPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2025-09-23T22:15:15.344Z",
    "policies": [
      {
        "id": "ph-tos-ncii",
  ...
  },
  {
    ...
    "summary": "US federal law enacted May 19, 2025, prohibiting nonconsensual intimate visual depictions including deepfakes, requiring covered platforms to implement 48-hour notice-and-removal processes by May 19, 2026.",
