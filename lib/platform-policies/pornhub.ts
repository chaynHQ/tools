...
export const pornhubPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2025-11-24T09:07:10.292Z",
    "policies": [
      {
        "id": "ph-tos-ncii",
    ...
    "appealProcess": {
      ...
      "summary": "Users may lodge a complaint within 6 months of being notified of a decision by emailing from their associated account with detailed information and explanation of their complaint",
      "steps": [
        "Submit complaint within six (6) months after notification of the decision",
        "Email dsa@pornhub.com from the email associated with your account or from which notice was communicated",
