...
export const pornhubPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2026-04-20T09:39:37.330Z",
    "policies": [
      {
        "id": "ph-tos-ncii",
    ...
    "appealProcess": {
      "url": "dsa@pornhub.com",
      "summary": "Users may lodge a complaint against content moderation decisions within six months of notification",
      "steps": [
        "Email dsa@pornhub.com from the email associated with your account or from which notice of the decision was communicated",
        "Include as much information as possible to allow investigation of your complaint",
        "Provide an explanation of the reason(s) for which you believe your complaint to be justified",
        "Complaints are handled in a timely, non-discriminatory, diligent, and objective manner"
      ]
    }
  },
  {
  ...
  },
  {
    ...
    "policies": [
      ...
      },
      {
        ...
        "reference": "Non-Consensual Content Policy",
        "summary": "Strictly prohibits the recording, distribution, or threatened distribution of intimate images without consent",
        "quote": "The recording, distribution, or threatened distribution of intimate images (that is, photos and videos that are generally understood to depict explicit sexual activity or nudity or partial nudity) without someone's consent is a violation of that person's privacy and is a severe violation of our Terms of Service and is strictly prohibited.",
        "contentTypes": [
          "intimate"
        ],
        "contentContexts": [
        ...
        "removalCriteria": [
          ...
          "Threatened distribution of intimate images without consent"
        ]
      },
      {
      ...
      },
      {
        "id": "ph-ncii-threats",
        "reference": "Non-Consensual Content Policy - Guidelines",
        "summary": "Prohibits threatening to publish, distribute, or make available intimate images or videos without consent",
        "quote": "Threatening to publish, distribute, or otherwise make available intimate images or videos of another person without their consent, including real, simulated, or AI-generated content, regardless of whether such content exists or is ultimately shared.",
        "contentTypes": [
          "intimate"
        ],
        "contentContexts": [
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Threatening to publish intimate images without consent",
          "Threatening to distribute intimate videos without consent",
          "Threats involving real, simulated, or AI-generated content"
        ]
      },
      {
        ...
        "removalCriteria": [
          ...
          "Content likely to be mistaken for real recordings of identifiable persons"
        ]
      },
      {
    ...
    "appealProcess": {
      ...
      "summary": "Users can report violations through the Content Removal Request Form for confidential review and expeditious removal",
      "steps": [
        ...
        "Content will be removed expeditiously upon verification"
      ]
    }
  },
  {
    "id": "pornhub-new-1776677977330-0",
    "reference": "PH-TRANSPARENCY-2024",
    "title": "Pornhub Transparency Report 2024",
    "summary": "Annual transparency report detailing content moderation practices, removal statistics, and safety measures implemented by Pornhub in compliance with Digital Services Act requirements.",
  ...
  {
    "id": "pornhub-new-1776677977330-1",
    "reference": "PH-CONTENT-REMOVAL",
    "title": "Pornhub Content Removal Request Form",
    "summary": "Official content removal request mechanism allowing users to report non-consensual content, with immediate disabling policy for reported content pending review.",
    ...
    "policies": [
      {
        "id": "ph-cr-ncc",
        "reference": "Non-Consensual Content Policy",
        "summary": "Prohibits non-consensual sexual acts, recording without consent, distribution without consent, doxxing, and deepfakes or AI-generated content using someone's likeness without consent",
        "quote": "You may submit requests for removal for content that: Violates our Non-Consensual Content (NCC) Policy... The content shows non-consensual sexual acts... One or more individual(s) in the content did not consent to being recorded... One or more individual(s) in the content did not consent for the content to be distributed... The content contains personal identifying information (\"doxxing\")... The content is a \"deepfake\" or is AI-generated or manipulated and uses someone's likeness without their consent",
        "contentTypes": [
          "intimate",
          "personal",
          "private"
        ...
        "timeframes": {
          ...
          "removal": {
            "value": null,
            "unit": "immediate",
            "description": "All valid content URLs will be immediately disabled upon verification"
          }
        },
        "evidenceRequirements": [
          {
            "description": "URL(s) of the content being reported",
            "example": "Direct links to the infringing content on the platform",
            "reason": "To locate and remove the specific content"
          },
          {
            "description": "Relationship to the person in the content",
            "example": "I am the person in the content, family member, authorized representative, etc.",
            "reason": "To verify standing to make the removal request"
          },
          {
            "description": "Additional information about the request",
            "example": "Timestamps, content titles, usernames, or other identifying details",
            "reason": "To help locate content when URLs are not available"
          }
        ],
        "removalCriteria": [
      ...
      {
        "id": "ph-cr-csam",
        "reference": "Child Sexual Abuse Material Policy",
        "summary": "Prohibits child sexual abuse material and content that raises child safety concerns",
        "quote": "You may submit requests for removal for content that: Violates our Child Sexual Abuse Material (CSAM) Policy... CSAM or Child Safety Concern",
        "contentTypes": [
          "intimate",
          "personal",
          "other"
        ...
        "evidenceRequirements": [
          {
            "description": "URL(s) of the content being reported",
            "example": "Direct links to the content on the platform",
            "reason": "To locate and remove the specific content"
          },
          {
            "description": "Description of child safety concern",
            "example": "Details about why the content violates CSAM policy",
            "reason": "To assess the nature of the violation"
          }
        ],
        "removalCriteria": [
          "Content violates Child Sexual Abuse Material (CSAM) Policy",
          "Content raises child safety concerns"
        ]
      },
      {
        "id": "ph-cr-consent-withdrawal",
        "reference": "Performer Consent Withdrawal",
        "summary": "Allows performers to withdraw from existing consent agreements and request removal of content",
        "quote": "You may submit requests for removal for content that: Features a performer who wishes to withdraw from an existing consent agreement... Performer is Withdrawing from Consent Agreement to Appear in Content... No permission was given for this content to be uploaded to Pornhub... Permission was given for limited use only (e.g. long-form videos or promotional purposes), but this upload does not follow those terms... The consent provided is no longer valid or was not valid in the first place",
        "contentTypes": [
          "intimate",
          "personal"
        ],
        ...
        "evidenceRequirements": [
          ...
          {
            "description": "Explanation of consent withdrawal or violation",
            "example": "Details about why consent is being withdrawn or how the consent agreement was violated",
            "reason": "To verify the validity of the consent-related claim"
          }
        ],
        "removalCriteria": [
      ...
      },
      {
        ...
        "reference": "Consent Agreement Violation",
        "summary": "Prohibits content that violates existing performer consent agreements",
        "quote": "You may submit requests for removal for content that: Violates an existing performer consent agreement... The Content Violates a Consent Agreement",
        "contentTypes": [
          "intimate",
          "personal"
        ],
        ...
        "evidenceRequirements": [
          ...
          {
            "description": "Details of consent agreement violation",
            "example": "Explanation of how the content violates the existing consent agreement",
            "reason": "To verify the violation of the consent agreement"
          }
        ],
        "removalCriteria": [
    ...
    "appealProcess": {
      "url": "https://www.pornhub.com/anonymous-content-removal",
      "summary": "Anonymous reporting option available for CSAM or NCC content when users do not wish to provide contact information",
      "steps": [
        "Submit anonymous report for CSAM or NCC content",
        "Content will be reviewed by dedicated support team",
        "Valid content will be removed upon verification"
      ]
    }
  },
  {
    "id": "pornhub-new-1776677977330-2",
    "reference": "PH-TRUSTED-FLAGGER",
    "title": "Pornhub Trusted Flagger Program",
    "summary": "Partnership program with over 40 non-profit organizations including Cyber Civil Rights Initiative and National Center for Missing & Exploited Children for direct content moderation access.",
    "url": "https://www.pornhub.com/trusted-flaggers",
    "accessTimestamp": "2026-04-20T09:39:37.330Z",
    "policies": [],
    "appealProcess": null
  }
