...
export const pornhubPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2026-03-30T09:33:32.147Z",
    "policies": [
      {
        "id": "ph-tos-ncii",
    ...
    "appealProcess": {
      ...
      "summary": "Users may lodge complaints against content moderation decisions within six months of notification",
      "steps": [
        "Email dsa@pornhub.com from the email associated with your account or from which the decision was communicated",
        "Include as much information as possible to allow investigation of your complaint",
        "Provide explanation of the reason(s) for which you believe your complaint to be justified",
        "Complaints are handled in a timely, non-discriminatory, diligent, and objective manner",
        "Previous decisions may be reversed if complaint demonstrates content did not violate applicable law, third party rights, or terms of service"
      ]
    }
  },
  {
