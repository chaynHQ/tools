...
export const pornhubPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2026-06-15T11:09:25.018Z",
    "policies": [
      {
        "id": "ph-tos-ncii",
  ...
  },
  {
    ...
    "policies": [
      ...
      },
      {
        "id": "ph-ncii-threats",
        "reference": "Non-Consensual Content Policy - Guidelines",
        "summary": "Prohibits threatening to publish, distribute, or make available intimate images without consent, including AI-generated content",
  ...
  {
    "id": "pornhub-new-1781521765018-0",
    "reference": "PH-TRANSPARENCY-2025",
    "title": "Pornhub Transparency Report 2025",
    "summary": "Annual transparency report detailing content moderation statistics, removal processes, and safety measures including data on community guideline violations and automated detection technologies.",
  ...
  {
    "id": "pornhub-new-1781521765018-1",
    "reference": "PH-COMMUNITY-GUIDELINES",
    "title": "Pornhub Community Guidelines",
    "summary": "Comprehensive community standards covering prohibited content including non-consensual material, harassment, impersonation, and content verification requirements for uploaders.",
  ...
  {
    "id": "pornhub-new-1781521765018-2",
    "reference": "PH-DMCA-POLICY",
    "title": "Pornhub DMCA Copyright Policy",
    "summary": "Digital Millennium Copyright Act compliance policy detailing copyright takedown procedures, counter-notice processes, and repeat infringer policies.",
