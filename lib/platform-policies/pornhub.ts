...
export const pornhubPolicy: PlatformPolicies = {
  ...
  },
  {
    ...
    "policies": [
      ...
      {
        "id": "take-it-down-notice-requirement",
        "reference": "Section 3(a)(2)",
        "summary": "Requires covered platforms to provide clear and conspicuous notice of the removal request process, including how individuals can submit a notification and request for removal",
      ...
      {
        "id": "take-it-down-good-faith-liability-limitation",
        "reference": "Section 3(a)(4)",
        "summary": "Protects platforms from liability for good faith removal of content reasonably believed to be a nonconsensual intimate visual depiction, supporting proactive takedown action",
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Facts or circumstances exist from which unlawful publishing of an intimate visual depiction is apparent"
        ]
      },
      {
        "id": "take-it-down-enforcement-ftc",
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Platform fails to reasonably comply with the notice and takedown obligations established under this Act"
        ]
      }
    ],
    "appealProcess": null
  },
  {
    ...
    "policies": [
      ...
      {
        "id": "ph-ncii-threatened-distribution",
        "reference": "Non-Consensual Content Policy - Guidelines",
        "summary": "Prohibits threatening to publish or distribute intimate images or videos of another person without their consent, including real, simulated, or AI-generated content, regardless of whether it exists or is shared",
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Threats to publish or distribute intimate images without consent",
          "Threats involving real, simulated, or AI-generated content",
          "Threats made regardless of whether the content actually exists"
        ]
      },
      {
        "id": "ph-ncii-non-consensual-activity-depictions",
        "reference": "Non-Consensual Content Policy - Guidelines",
        "summary": "Prohibits content, including fictional, simulated, or animated content, that depicts non-consensual sexual activity such as coerced or forced acts, rape, or sexual assault",
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Depictions of coerced or forced sexual activity",
          "Depictions of rape or sexual assault",
          "Fictional, simulated, or animated depictions of non-consensual acts"
        ]
      },
      {
        "id": "ph-ncii-deepfakes",
        "reference": "Non-Consensual Content Policy - Guidelines",
        "summary": "Prohibits any deepfakes or AI-generated manipulations of a person's image to deceive viewers, including content likely to be mistaken for a real recording of an identifiable person",
        ...
        "removalCriteria": [
          ...
          "AI-generated or manipulated content likely to be mistaken for a real recording of an identifiable person"
        ]
      },
      {
      ...
      {
        "id": "ph-ncii-sensitive-themes-consent",
        "reference": "Non-Consensual Content Policy - Sensitive Themes and Consideration for Consent",
        "summary": "Requires that consent be clearly determinable by a reasonable observer from the content itself, applying to both creation and distribution, including AI-generated or manipulated representations, and prohibits content depicting sensitive themes (such as possession, sleep, bondage, or sub-dom fantasies) where consent cannot be clearly established",
        "quote": "Consent must be determinable by the reasonable observer from the material itself, which may be assessed either through clear verbal or visual cues. Consent must apply to both the creation and distribution of the content, including AI-generated or manipulated representations.",
        "contentTypes": [
          "intimate"
        ],
        "contentContexts": [
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Content where consent cannot be determined by a reasonable observer from the material itself",
          "Depictions of incapacitated or unconscious performers due to possession, spells, or mesmerizing",
          "Performers displaying signs of distress or panic before, during, or after an act",
          "Sleep content where the person does not wake within a reasonable time and clearly consent",
          "Bondage or restraint content lacking clear consent to continued participation",
          "Sub-dom fantasy content lacking clear verbal or visual consent cues"
        ]
      }
    ],
    "appealProcess": null
