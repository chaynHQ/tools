...
export const pornhubPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2026-03-09T09:17:50.836Z",
    "policies": [
      {
        "id": "ph-tos-ncii",
    ...
    "appealProcess": {
      ...
      "summary": "Users may lodge complaints against content decisions within 6 months of notification via email or webform",
      "steps": [
        "Submit complaint within 6 months of decision notification",
        ...
        "Website handles complaints in timely, non-discriminatory, diligent manner",
        "Website may reverse decisions if complaint demonstrates content did not violate policies or decision was unjustified"
      ]
    }
  },
  {
