...
export const pornhubPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2026-06-08T10:38:09.645Z",
    "policies": [
      {
        "id": "ph-tos-ncii",
    ...
    "appealProcess": {
      ...
      "steps": [
        ...
        "Platform will handle complaint in timely, non-discriminatory manner",
        "Platform may reverse decision if complaint demonstrates content did not violate terms or decision was unjustified"
      ]
    }
  },
  {
  ...
  {
    "id": "pornhub-new-1780915089645-0",
    "reference": "FTC-AYLO-ORDER",
    "title": "FTC Enforcement Action Against Aylo (Pornhub Operators)",
    "summary": "Federal Trade Commission enforcement action against Pornhub operators for deceiving users about efforts to crack down on child sexual abuse material and nonconsensual content, resulting in $5 million penalty and mandatory compliance program.",
    ...
    "policies": [
      {
        "id": "ftc-aylo-csam-ncm-prohibition",
        "reference": "FTC-AYLO-ORDER",
        "summary": "Prohibits the publication or dissemination of child sexual abuse material and nonconsensual material on websites",
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Content depicts child sexual abuse material",
          "Content is nonconsensual material"
        ]
      },
      {
        "id": "ftc-aylo-age-consent-verification",
        "reference": "FTC-AYLO-ORDER",
        "summary": "Requires verification that individuals in content are adults who consented to the sexual conduct and its production and publication",
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Individual in content was under 18 at time of creation",
          "Individual did not consent to the sexual conduct",
          "Individual did not consent to production of the content",
          "Individual did not consent to publication of the content"
        ]
      },
      {
        "id": "ftc-aylo-legacy-content-removal",
        "reference": "FTC-AYLO-ORDER",
        "summary": "Requires removal of previously uploaded content until verification of age and consent is completed",
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Content was uploaded before implementation of prevention program",
          "Age verification has not been completed for individuals in content",
          "Consent verification has not been completed for individuals in content"
        ]
      },
      {
        "id": "ftc-aylo-reporting-response",
        "reference": "FTC-AYLO-ORDER",
        "summary": "Requires a process to respond to reports about child sexual abuse material and nonconsensual material",
        "quote": "a process to respond to reports about CSAM and NCM content on its websites",
        "contentTypes": [
          "intimate",
          "personal"
        ],
        ...
        "evidenceRequirements": [],
        "removalCriteria": [
          "Content is reported as child sexual abuse material",
          "Content is reported as nonconsensual material"
        ]
      }
    ],
    "appealProcess": null
