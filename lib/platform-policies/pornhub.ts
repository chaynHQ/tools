...
export const pornhubPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
  {
    ...
    "accessTimestamp": "2026-05-11T10:15:52.631Z",
    "policies": [
      {
        "id": "ph-tos-ncii",
    ...
    "appealProcess": {
      ...
      "summary": "Users may lodge a complaint within 6 months of being notified of a decision through email or webform",
      "steps": [
        ...
        "Provide explanation of reasons why you believe complaint is justified",
