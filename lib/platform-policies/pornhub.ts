...
export const pornhubPolicy: PlatformPolicies = {
  ...
  policyDocuments: [
      ...
      policies: [
        {
          ...
          summary:
            'Prohibits non-consensual content including revenge porn, blackmail, and intimidation',
          quote:
            'the Website does not permit any form of revenge porn, blackmail, or intimidation, and such violations may also be reported using the content removal link herein.',
        ...
        },
        {
          ...
          summary:
            'Prohibits posting content depicting non-consensual activity, revenge porn, blackmail, and intimidation',
          quote:
        ...
        },
        {
          ...
          reference: 'Prohibited Uses and Reporting',
          summary:
            'Prohibits content that impersonates another person or misrepresents affiliation',
          quote:
        ...
        },
        {
          ...
          reference: 'Prohibited Uses and Reporting',
          summary:
            'Prohibits conduct that is harmful, threatening, abusive, harassing, stalking, or invasive of privacy',
          quote:
        ...
        },
        {
          ...
          summary:
            'Prohibits posting copyrighted materials without permission and provides DMCA takedown process',
          quote:
        ...
        },
        {
          ...
          reference: 'Prohibited Uses and Reporting',
          summary:
            'Provides mechanism for reporting content that violates laws, third party rights, or terms of service',
          quote:
            'If you see any Content you suspect violates applicable law, third party rights, or these Terms of Service, please report such Content to us, using the electronic form available at https://pornhub.com/content-removal, or the "Report" button available below each piece of content.',
          contentTypes: ['intimate', 'personal', 'private', 'other'],
        ...
        },
        {
          ...
          summary:
            'Requires consent and release for every individual appearing in uploaded content',
          quote:
            'you have obtained the consent and release for every individual appearing in your Content, including the right for you to use and upload the Content on this Website',
          contentTypes: ['intimate', 'personal'],
          contentContexts: ['relationship', 'hacked', 'unknown', 'other'],
          timeframes: null,
          evidenceRequirements: [],
      ...
      policies: [
        {
          ...
          summary:
            'Prohibits posting of personal information without consent and provides mechanisms for content removal',
          quote:
            'We may disclose all categories of personal information we process to a buyer or other successor in the event of a merger, acquisition or sale or transfer of some or all our assets, whether as a going concern or as part of bankruptcy, liquidation, or similar proceeding. Such transactions may be in our legitimate interest, particularly our interest in making decisions that enable our business to develop.',
          contentTypes: ['private', 'personal', 'other'],
          contentContexts: ['other', 'unknown'],
          timeframes: null,
          evidenceRequirements: [],
          removalCriteria: [],
        },
        {
          ...
          summary:
            'Warns users that content they post becomes publicly available and can be accessed by others',
          quote:
        ...
        },
        {
          ...
          reference:
            'Section 8 - Your Choices About How We Collect, Use and Disclose Your Personal Information',
        ...
        },
        {
          ...
          reference:
            'Section 8 - Your Choices About How We Collect, Use and Disclose Your Personal Information',
          summary:
            'Allows users to delete their uploaded content and audio/video information through account settings',
          quote:
          ...
          timeframes: null,
          evidenceRequirements: [],
          removalCriteria: ['User requests deletion through account settings'],
        },
        {
          ...
          removalCriteria: ['Valid data deletion request', 'Identity verification completed'],
        },
        {
          id: 'ph-pp-biometric-consent-withdrawal',
          reference: 'Section 11 - Biometric Information',
          summary:
            'Allows users to withdraw consent for biometric information processing at any time',
          quote:
            'You will be asked to provide your consent to biometric information processing which you may withdraw at any time. Withdrawing your consent will not affect the lawfulness of any collection, use, processing, or disclosure that occurred prior to the withdrawal.',
          ...
          evidenceRequirements: [],
          removalCriteria: ['User withdraws consent for biometric processing'],
        },
      ],
      appealProcess: null,
    },
    ...
    },
    {
      ...
      summary:
        'US federal law prohibiting nonconsensual intimate visual depictions of individuals, both authentic and computer-generated, requiring platforms to implement notice-and-removal processes within 48 hours. Signed into law May 19, 2025.',
      ...
      policies: [
        {
          ...
          summary:
            'Prohibits knowingly publishing authentic intimate visual depictions of adults without consent when obtained under circumstances with reasonable expectation of privacy, not voluntarily exposed publicly, not matter of public concern, and intended to cause or causing harm',
          quote:
        ...
        },
        {
          ...
          summary:
            'Prohibits knowingly publishing digital forgeries (deepfakes) of adults without consent when not voluntarily exposed publicly, not matter of public concern, and intended to cause or causing harm',
          quote:
        ...
        },
        {
          ...
          summary:
            'Requires covered platforms to remove nonconsensual intimate visual depictions within 48 hours of receiving a valid removal request and make reasonable efforts to remove identical copies',
          quote:
        ...
        },
        {
          ...
          summary:
            'Prohibits intentionally threatening to commit offenses involving authentic intimate visual depictions for purposes of intimidation, coercion, extortion, or creating mental distress',
          quote:
        ...
        },
        {
          ...
          summary:
            'Prohibits intentionally threatening to commit offenses involving digital forgeries (deepfakes) for purposes of intimidation, coercion, extortion, or creating mental distress',
          quote:
    ...
    },
    {
      ...
      summary:
        'Dedicated policy document specifically addressing non-consensual intimate imagery, including detection technologies, reporting processes, and enforcement measures.',
      ...
      policies: [
        {
          ...
          reference: 'Non-Consensual Content Policy',
          summary:
            'Requires all uploaders to obtain and maintain valid consent and proper release documentation for all persons featured in uploaded content',
          quote:
            'We require all uploaders to affirm they have obtained and maintain valid consent and proper release documentation for all persons featured in all content uploaded to the platform.',
          contentTypes: ['intimate', 'personal'],
          contentContexts: ['relationship', 'unknown', 'other'],
          timeframes: null,
          evidenceRequirements: [],
        ...
        },
        {
          ...
          reference: 'Non-Consensual Content Policy',
          summary:
            'Strictly prohibits the recording or distribution of intimate images without consent',
          quote:
        ...
        },
        {
          ...
          summary:
            'Prohibits videos or photos of any person taken without valid written consent, including hidden camera content',
          quote:
        ...
        },
        {
          ...
          reference: 'Non-Consensual Content Policy - Guidelines',
          summary:
            'Prohibits sharing explicit sexual images of someone without their valid written consent, including revenge sharing',
          quote:
        ...
        },
        {
          ...
          reference: 'Non-Consensual Content Policy - Guidelines',
          summary:
            'Prohibits sharing non-sexually explicit images of someone without their valid written consent',
          quote:
          ...
          timeframes: null,
          evidenceRequirements: [],
          removalCriteria: ['Sharing non-sexually explicit images without valid written consent'],
        },
        {
          id: 'ph-ncii-doxing',
          reference: 'Non-Consensual Content Policy - Guidelines',
          summary:
            'Prohibits doxing, defined as exposing private and identifying information about individuals',
          quote:
        ...
        },
        {
          ...
          reference: 'Non-Consensual Content Policy - Guidelines',
          summary:
            "Prohibits any deepfakes or AI-generated manipulations of a person's image to deceive viewers",
          quote:
        ...
        },
        {
          ...
          reference: 'Non-Consensual Content Policy - Guidelines',
          summary:
            'Prohibits content featuring or promoting non-consensual acts, whether real or simulated',
          quote:
            'Content featuring or promoting non-consensual acts, real or simulated, is also prohibited.',
          contentTypes: ['intimate'],
        ...
        },
        {
          ...
          reference: 'Non-Consensual Content Policy - Guidelines',
          summary:
            'Prohibits content depicting persons appearing drugged, incapacitated, or intoxicated involved in sexual acts',
          quote:
