...
+
         ...
         console.log(`::set-output name=platform_name::${PLATFORM_NAMES[platform]}`);
         console.log(`::set-output name=reasoning::${validationResult.reasoning}`);
         console.log(`::set-output name=error::${error instanceof Error ? error.message : 'Unknown PR creation error'}`);
       }
     } else {
...
+    });
     ...
     console.log(`::set-output name=error::${error instanceof Error ? error.message : 'Unknown error'}`);
